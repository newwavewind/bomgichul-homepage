...
const SHARED_TAIL: FaqItem[] = [
  {
    ...
    answer:
      "로그인만 하면 됩니다. 결제는 없어요. 해설·오답노트·북마크·랜덤·복습·PDF 다운로드, 풀이 기록, 커뮤니티·자료실 글쓰기까지 홈페이지 기능은 전부 무료로 열립니다. Google 계정만 있으면 됩니다.",
  },
  {
...
function trackFaq(scope: Exclude<CommunityScope, "real_estate">): FaqItem[] {
  ...
  return [
    ...
    },
    {
      ...
      answer: `${label} 기출 올인원·공개 기출·커뮤니티·자료실 읽기는 로그인 없이 가능합니다. 로그인하면 해설·오답노트·북마크·랜덤·복습·PDF까지 홈페이지 기능을 전부 무료로 쓸 수 있어요.`,
    },
    ...SHARED_TAIL,
    {
