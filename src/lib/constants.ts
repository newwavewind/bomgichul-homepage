...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "기출 올인원 개념은 열어볼 수 있고, 부동산학개론 기출은 전 연도가 무료입니다. 나머지 5과목 기출은 최근 2개년(2024·2025)이 기본 무료예요. 커뮤니티·자료실·뉴스 읽기도 로그인 없이 가능합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "과목별 프리미엄은 「봄기출 공인중개사」 모바일 앱(App Store·Google Play)에서 구매합니다. 받은 코드를 홈페이지 해당 과목 기출 페이지 하단 코드 등록에 넣으면, 같은 Google 계정으로 홈페이지와 PC앱이 함께 해제됩니다.",
  },
  {
    question: "PC앱은 뭐고 주소는 어디인가요?",
    answer:
      "큰 화면용 학습 화면입니다. https://app.bomgichul.com 으로 들어가며, 홈페이지에서 등록한 과목 프리미엄이 그대로 적용됩니다.",
  },
  {
