...
export function BookmarkButton({
  ...
  if (!userId) {
    return (
      <Link
        ...
        className="inline-flex items-center gap-1 rounded-[var(--radius-buttons)] border border-carbon bg-paper px-3 py-1 font-display text-[12px] font-medium text-ink transition-colors hover:bg-snow"
      >
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1 rounded-[var(--radius-buttons)] border border-carbon px-3 py-1 font-display text-[12px] font-medium transition-colors disabled:opacity-60 ${
        bookmarked
