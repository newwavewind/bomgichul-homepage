...
export function BookmarkButton({
  ...
  if (!userId) {
    return (
      <Link
        ...
        className="inline-flex items-center gap-1.5 rounded-[var(--radius-buttons)] border border-carbon bg-paper px-3.5 py-1.5 font-display text-body-sm font-medium text-ink transition-colors hover:bg-snow"
      >
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1.5 rounded-[var(--radius-buttons)] border border-carbon px-3.5 py-1.5 font-display text-body-sm font-medium transition-colors disabled:opacity-60 ${
        bookmarked
