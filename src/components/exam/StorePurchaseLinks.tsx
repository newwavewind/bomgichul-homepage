...
export function StorePurchaseLinks({
  ...
  const btnClass =
    size === "sm"
      ...
      : "inline-flex items-center justify-center gap-2 rounded-[var(--radius-buttons)] border-[1.5px] border-carbon bg-paper px-4 py-2 font-display text-body-sm font-medium text-ink shadow-[var(--shadow-button)] transition-colors hover:bg-snow";
