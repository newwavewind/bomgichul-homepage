...
import { getSemusaSubject, getSemusaConcept, getSemusaExam, getSemusaExamSessions, getSemusaLinkedExams } from "@/lib/semusa-content";
import {
  TrackExamDetailPage,
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return trackExamDetailMetadata(SEMUSA_TRACK, api, subject, year, source, no);
}
