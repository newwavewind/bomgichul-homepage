...
import { getHaengjeongsaSubject, getHaengjeongsaConcept, getHaengjeongsaExam, getHaengjeongsaExamSessions, getHaengjeongsaLinkedExams } from "@/lib/haengjeongsa-content";
import {
  TrackExamDetailPage,
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return trackExamDetailMetadata(HAENGJEONGSA_TRACK, api, subject, year, source, no);
}
