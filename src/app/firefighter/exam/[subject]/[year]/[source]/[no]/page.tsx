...
import { getFirefighterSubject, getFirefighterConcept, getFirefighterExam, getFirefighterExamSessions, getFirefighterLinkedExams } from "@/lib/firefighter-content";
import {
  TrackExamDetailPage,
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return trackExamDetailMetadata(FIREFIGHTER_TRACK, api, subject, year, source, no);
}
