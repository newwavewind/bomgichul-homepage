...
import { getGugeoSubject, getGugeoConcept, getGugeoExam, getGugeoExamSessions, getGugeoLinkedExams } from "@/lib/gugeo-content";
import {
  TrackExamDetailPage,
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return trackExamDetailMetadata(GUGEO_TRACK, api, subject, year, source, no);
}
