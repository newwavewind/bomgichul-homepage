...
const concepts: Concept[] = [
  ...
  },
  {
    ...
    pitfalls:
      "한국토지주택공사도 다른 민간참여자처럼 토지면적 3분의 2 이상 소유·소유자 동의가 필요하다고 착각하기 쉽지만, 한국토지주택공사는 동의 요건 없이 시행자로 지정받을 수 있다.",
    example:
      "도시·군관리계획으로 결정된 하천의 정비사업은 도시·군계획시설사업에 해당하며, 행정청인 시행자가 새로 설치한 공공시설은 그 시설을 관리할 관리청에 무상으로 귀속된다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "도시·군기본계획 입안일부터 5년 이내에 토지적성평가를 실시한 경우 재실시를 생략할 수 있고, 시장·군수는 5년마다 관할 구역의 도시·군기본계획 타당성을 전반적으로 재검토·정비해야 하며, 인접 시·군을 포함해 계획을 수립하려면 미리 협의하고 지방의회 의견을 들어야 하며, 승인 신청 시에는 기초조사 결과를 첨부해야 한다.",
    intuition:
      "도시·군기본계획 문제는 '숫자(5년 재검토, 5년 이내 토지적성평가 생략)'와 '절차 주체(협의·의견청취 대상, 승인 시 첨부서류)'를 조합해 오답을 만드는 방식이 반복된다.",
    keyPoints: [
      "도시·군기본계획 입안일부터 5년 이내에 토지적성평가를 실시한 경우 등 대통령령으로 정하는 경우에는 토지적성평가 또는 재해취약성분석을 하지 않을 수 있으며, 시장·군수는 5년마다 관할 구역의 도시·군기본계획에 대해 타당성을 전반적으로 재검토하여 정비해야 한다.",
      ...
      "특별시장·광역시장·특별자치시장·특별자치도지사는 도시·군기본계획을 변경하려면 국토교통부장관을 포함한 관계 행정기관의 장과 협의한 후 지방도시계획위원회의 심의를 거쳐야 하며, 시장·군수가 계획을 변경하려는 경우에도 도지사와 협의한 후 지방도시계획위원회의 심의를 거쳐야 한다(심의 생략 불가).",
      "시장·군수가 도시·군기본계획의 승인을 받으려 할 때 계획안에 첨부해야 할 서류는 기초조사 결과이며, 청문조서, 의회의 심의·의결 결과, 지방도시계획위원회의 심의 결과, 관계 중앙행정기관 협의·중앙도시계획위원회 심의 필요서류는 첨부서류로 명시되어 있지 않다.",
    ],
    pitfalls:
      "도지사와의 협의 후 지방도시계획위원회 심의를 생략할 수 있다고 오해하기 쉽지만, 계획 변경 시에도 반드시 심의를 거쳐야 한다.",
    example:
  ...
  },
  {
    ...
    definition:
      "개발제한구역·국가계획과 연계된 시가화조정구역·둘 이상 시·도에 걸친 국토교통부장관 입안 사항은 국토교통부장관이, 지구단위계획구역·입지규제최소구역·도시자연공원구역 등은 원칙적으로 시·도지사(또는 대도시 시장)가 결정하며, 도시·군관리계획 결정의 효력은 지형도면을 고시한 날부터(다음 날이 아님) 발생하고, 시가화조정구역 지정 당시 이미 착수한 사업자는 신고 후 계속 시행할 수 있다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "주민은 기반시설의 설치·정비·개량, 지구단위계획구역의 지정·변경 및 지구단위계획의 수립·변경, 입지규제최소구역의 지정·변경 및 계획 수립, 산업·유통개발진흥지구의 지정·변경, 용도지구를 지구단위계획으로 대체하기 위한 용도지구 지정에 관한 사항을 입안권자에게 제안할 수 있지만 시가화조정구역의 지정·변경은 제안 대상이 아니며, 기반시설의 '설치'는 토지면적의 5분의 4 이상, 그 밖의 사항은 3분의 2 이상의 동의가 필요하다(국·공유지 제외).",
    intuition:
      "입안 제안은 '제안 가능한 사항 목록(시가화조정구역은 제외)'과 '동의 비율(기반시설 설치는 5분의 4, 나머지는 3분의 2)'을 조합해 출제하므로 두 축을 분리해 암기해야 한다.",
    keyPoints: [
      "주민이 입안을 제안할 수 있는 사항에는 기반시설의 설치·정비·개량, 지구단위계획구역의 지정·변경과 지구단위계획의 수립·변경, 입지규제최소구역의 지정·변경과 계획의 수립·변경, 산업·유통개발진흥지구의 지정·변경, 용도지구를 지구단위계획으로 대체하기 위한 용도지구의 지정이 포함되지만, 시가화조정구역의 지정·변경에 관한 사항은 제안 대상이 아니다.",
      "기반시설의 '설치'에 관한 사항은 대상 토지면적의 5분의 4 이상, 기반시설의 '정비'에 관한 사항은 3분의 2 이상(5분의 4가 아님)의 토지소유자 동의가 필요하며, 지구단위계획구역의 지정·수립, 산업·유통개발진흥지구의 지정, 용도지구 대체 지정은 모두 3분의 2 이상의 동의가 필요하다.",
    ...
    pitfalls:
      "기반시설의 '설치'와 '정비'의 동의 비율을 같은 것으로 착각하기 쉽지만, 설치는 5분의 4 이상, 정비는 3분의 2 이상으로 서로 다르다.",
    example:
      "주민 甲이 기반시설의 설치에 관한 사항을, 주민 乙이 지구단위계획구역의 지정에 관한 사항을 각각 입안 제안하는 경우, 甲은 대상 토지면적의 5분의 4 이상, 乙은 3분의 2 이상의 토지소유자 동의를 받아야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "환경성 검토와 기초조사의 나대지면적 생략 기준을 같은 숫자로 착각하기 쉽지만, 환경성 검토는 2% 미달, 기초조사 관련 나대지 기준은 이와 다른 별도 수치이므로 혼동하지 않아야 한다.",
    example:
      "해당 지구단위계획구역 안의 나대지면적이 구역 면적의 2퍼센트에 미달하는 경우에는 도시·군관리계획을 입안할 때 환경성 검토를 실시하지 아니할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "시장 또는 군수는 광역도시계획을 수립하려는 경우, 성장관리방안을 수립하려는 경우, 시범도시사업계획을 수립하려는 경우, 기반시설부담구역을 지정하려는 경우에는 주민의 의견을 들어야 하지만, 개발밀도관리구역을 지정하려는 경우에는 주민의견 청취 의무가 명시되어 있지 않다.",
    intuition:
  ...
  },
  {
    ...
    example:
      "국토교통부장관 또는 시장·군수 등이 개발행위허가를 취소하거나 실시계획인가를 취소하려는 경우에는 청문을 실시하여야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "시·군·구에도 지방도시계획위원회를 두며, 중앙도시계획위원회가 분과위원회에 위임한 사항의 심의는 분과위원회의 심의가 곧 중앙도시계획위원회의 심의로 의제되는 경우와 그렇지 않은 경우가 구분되고, 국토교통부장관이 도시·군계획시설결정의 해제를 권고하려면 중앙도시계획위원회의 심의를 거쳐야 하며, 시·군·구도시계획위원회는 시장·군수·구청장의 자문에 대한 조언과 시장·군수가 결정하는 도시·군관리계획의 심의 등을 담당한다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "용도지역은 도시지역(주거·상업·공업·녹지지역), 관리지역(보전·생산·계획관리지역), 농림지역, 자연환경보전지역의 4대 분류로 구성되며, 계획관리지역은 관리지역에 속해 도시지역이 아니고, 자연녹지지역·근린상업지역·전용공업지역·생산녹지지역은 모두 도시지역에 해당한다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "아파트는 전용주거지역 중 제2종전용주거지역, 일반주거지역 중 제2종·제3종일반주거지역, 준주거지역에서는 건축할 수 있지만 계획관리지역·일반공업지역·유통상업지역·제1종일반주거지역에서는 건축할 수 없으며, 제3종일반주거지역에서 조례로 건축을 허용할 수 있는 건축물에는 위험물저장 및 처리시설 중 액화가스 취급소·판매소가 포함된다.",
    intuition:
    ...
    example:
      "국토의 계획 및 이용에 관한 법령상 아파트를 건축할 수 있는 용도지역에는 제2종전용주거지역, 제2종·제3종일반주거지역, 준주거지역이 포함된다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "새로운 용도지구는 시·도 또는 대도시의 도시·군계획조례로 신설할 수 있고(신설 불가라는 서술은 틀림), 용도지역 안 건축물 용도·종류·규모 제한 규정은 도시·군계획시설에는 적용되지 않으며, 공유수면 매립구역이 둘 이상의 용도지역과 이웃한 경우 매립목적과 같은 이웃 용도지역으로 지정된 것으로 보고, 매립목적이 이웃 용도지역과 다르면 지정 절차를 거쳐 따로 정하며, 택지개발지구·농업진흥지역 지정·고시는 각각 도시지역·농림지역으로 결정·고시된 것으로 의제된다.",
    intuition:
      "이 카드는 용도지역·지구·구역 전반에 걸친 개별 조문(신설 가능 여부, 시설사업 적용 제외, 매립구역 처리, 의제 규정)을 모아 두었으므로, 각 조문의 '예/아니오' 여부를 정확히 뒤집어 외우는 것이 핵심이다.",
    keyPoints: [
      "시·도 또는 대도시의 도시·군계획조례로는 법률에서 정한 용도지구 외에 새로운 용도지구를 신설할 수 있다(신설할 수 없다는 서술은 틀림).",
    ...
    pitfalls:
      "새로운 용도지구를 조례로 신설할 수 없다고 착각하기 쉽지만, 시·도·대도시의 도시·군계획조례로는 새로운 용도지구를 신설할 수 있다.",
    example:
      "시·도 또는 대도시의 도시·군계획조례는 법률에서 정하고 있는 용도지구 외에 새로운 용도지구를 신설할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "공업기능 및 유통·물류기능을 중심으로 개발·정비할 필요가 있는 용도지구는 산업·유통개발진흥지구이다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "자연취락지구 안에서는 단독주택, 마을회관, 도축장, 한의원 등 4층 이하의 건축물을 건축할 수 있지만, 동물 전용의 장례식장은 건축할 수 없다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "지구단위계획이나 관계 법률에 따른 개발계획을 수립하지 않는 개발진흥지구에서는 지정목적 범위에서 해당 용도지역의 허용 건축물을 건축할 수 있고, 고도지구에서는 도시·군관리계획으로 정한 높이를 초과할 수 없으며, 방재지구에서는 1층 전부를 필로티 구조로 하면 그 부분을 층수 산정에서 제외하고, 자연취락지구에서는 4층 이하의 방송통신시설을 건축할 수 있지만 일반주거지역에 지정된 복합용도지구에서는 장례시설을 건축할 수 없다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "성장관리계획구역은 녹지지역, 관리지역, 농림지역, 자연환경보전지역을 대상으로 지정할 수 있으며 주거지역은 대상이 아니고, 개발수요가 많아 무질서한 개발이 진행 중이거나 예상되는 계획관리지역·생산관리지역, 시가화가 예상되는 농림지역·자연환경보전지역도 성장관리방안 수립 대상이지만 '주변지역과 연계한 체계적 관리가 필요한 주거지역'은 대상이 아니다.",
    intuition:
    ...
    pitfalls:
      "주거지역도 난개발 우려가 있으면 성장관리계획구역으로 지정될 수 있다고 착각하기 쉽지만, 성장관리계획구역·성장관리방안은 애초에 도시지역이 아닌 지역(녹지·관리·농림·자연환경보전)을 대상으로 한다.",
    example:
      "국토의 계획 및 이용에 관한 법령상 성장관리계획구역을 지정할 수 있는 지역에는 녹지지역, 관리지역, 농림지역, 자연환경보전지역이 포함되지만 주거지역은 포함되지 않는다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "'용도지구'란 토지의 이용 및 건축물의 용도·건폐율·용적률·높이 등에 대한 용도지역의 제한을 강화하거나 완화하여 적용함으로써 용도지역의 기능을 증진시키고 경관·안전 등을 도모하기 위해 도시·군관리계획으로 결정하는 지역을 말한다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "건폐율 상한은 생산녹지지역 20% 이하 < 근린상업지역 70% 이하 < 유통상업지역 80% 이하 순으로 커지며, 계획관리지역의 농공단지는 조례로 최대 80%까지, 자연환경보전지역의 자연공원·수산자원보호구역은 각각 60%·40% 이하, 계획관리지역의 산업·유통개발진흥지구는 40%가 아니라 별도 상한을 적용받는다.",
    intuition:
    ...
    keyPoints: [
      ...
      "도시·군계획조례로 정할 수 있는 건폐율의 최대한도 중, 계획관리지역에 있는 「산업입지 및 개발에 관한 법률」상 농공단지는 자연환경보전지역의 자연공원(60% 이하)·수산자원보호구역(40% 이하)·도시지역 외 개발진흥지구·자연녹지지역 개발진흥지구보다 더 높은 상한(최대 80%)을 적용받는다.",
      "자연녹지지역에 지정된 개발진흥지구는 30% 이하, 수산자원보호구역은 40% 이하, 「자연공원법」상 자연공원은 60% 이하, 공업지역에 있는 「산업입지 및 개발에 관한 법률」상 준산업단지는 80% 이하의 건폐율이 적용된다.",
      "계획관리지역에 지정된 산업·유통개발진흥지구의 건폐율 상한은 40%가 아니라 별도로 정해진 다른 수치를 적용받는다(40% 이하라는 서술은 틀림).",
    ],
    pitfalls:
      "계획관리지역의 산업·유통개발진흥지구를 다른 개발진흥지구(자연녹지지역 30% 등)와 같은 낮은 수치로 착각하기 쉽지만, 실제로는 이보다 완화된 별도의 상한이 적용된다.",
    example:
      "도시지역의 건폐율 상한을 낮은 지역부터 높은 지역 순으로 나열하면 생산녹지지역(20% 이하) - 근린상업지역(70% 이하) - 유통상업지역(80% 이하) 순이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "용적률 최대한도는 제3종일반주거지역(300% 이하) 〈 일반공업지역(350% 이하) 〈 준공업지역(400% 이하) 〈 준주거지역(500% 이하) 순으로 커지며, 주거지역은 500% 이하, 계획관리지역은 100% 이하, 농림지역은 80% 이하이고, 근린상업지역·준주거지역·준공업지역·보전녹지지역·계획관리지역을 큰 순서로 나열하면 근린상업지역(900% 이하) 〉 준주거지역(500% 이하) 〉 준공업지역(400% 이하) 〉 계획관리지역(100% 이하) 〉 보전녹지지역(80% 이하) 순이다.",
    intuition:
    ...
    pitfalls:
      "일반공업지역과 준공업지역의 용적률 순서를 반대로 착각하기 쉽지만, 준공업지역(400%)이 일반공업지역(350%)보다 더 높다.",
    example:
      "준주거지역, 준공업지역, 일반공업지역, 제3종일반주거지역을 용적률의 최대한도가 낮은 지역부터 높은 지역까지 순서대로 나열하면 제3종일반주거지역 - 일반공업지역 - 준공업지역 - 준주거지역 순이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "시장·군수는 성장관리계획구역을 지정하려면 성장관리계획구역안을 14일간(7일이 아님) 일반이 열람할 수 있도록 해야 하고, 지정 시 도시·군관리계획의 결정으로 하는 것이 아니라 별도의 지정·고시 절차를 따르며, 성장관리계획구역 내 생산녹지지역·보전관리지역 등에서는 30% 이하(용적률은 125% 이하)의 범위에서 건폐율·용적률을 완화 적용할 수 있고, 공업지역은 향후 시가화가 예상되는 지역이라도 성장관리계획구역 지정 대상이 아니다.",
    intuition:
      "성장관리계획구역은 도시지역이 아닌 지역(녹지·관리·농림·자연환경보전)만을 대상으로 하므로 공업지역(도시지역)은 대상에서 제외되며, 지정 절차가 도시·군관리계획 결정이 아니라는 점과 열람기간(14일)의 정확한 숫자가 핵심이다.",
    keyPoints: [
      "시장·군수는 공업지역(도시지역)에는 성장관리계획구역을 지정할 수 없다 — 성장관리계획구역은 녹지·관리·농림·자연환경보전지역만을 대상으로 한다.",
      "시장·군수는 성장관리계획구역을 지정할 때 도시·군관리계획의 결정으로 하지 않는다(도시·군관리계획 결정 절차가 아님).",
      "시장·군수는 성장관리계획구역을 지정하려면 성장관리계획구역안을 14일간 일반이 열람할 수 있도록 해야 한다(7일이 아님).",
      "성장관리계획구역 내 생산녹지지역에서는 30% 이하의 범위에서, 보전관리지역에서는 125% 이하의 범위에서 성장관리계획으로 정하는 바에 따라 각각 건폐율·용적률을 완화 적용할 수 있다.",
    ],
    pitfalls:
  ...
  },
  {
    ...
    definition:
      "개발밀도관리구역의 변경고시는 해당 지방자치단체의 공보에 게재하는 방법으로 하며, 농림지역은 개발밀도관리구역으로 지정될 수 있는 지역에 포함되지 않고, 지정은 해당 지방자치단체의 지방도시계획위원회 심의대상이며, 개발밀도관리구역은 기반시설부담구역으로 지정될 수 없고, 개발밀도관리구역에서는 건폐율이 아니라 '용적률'의 최대한도의 50% 범위에서 이를 강화하여 적용한다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "지구단위계획구역 및 지구단위계획은 도시·군관리계획으로 결정하며(도시·군기본계획이 아님), 관광특구·관광단지·도시개발구역 전부·일부에 대해서도 지정할 수 있고, 지구단위계획의 수립기준은 국토교통부장관이 정하며, 건축물의 형태·색채에 관한 계획도 내용에 포함될 수 있고, 지구단위계획이 수립된 구역에서는 공사기간 중 이용하는 공사용 가설건축물도 그 지구단위계획에 맞게 건축해야 한다.",
    intuition:
    ...
    keyPoints: [
      ...
      "'두 개의 노선이 교차하는 대중교통 결절지로부터 2km 이내'라는 기준은 지구단위계획구역 의무 지정 사유가 아니다 — 이는 입지규제최소구역의 '세 개 이상 노선 교차·1km 이내' 기준과 다른, 존재하지 않는 기준이다.",
  ...
  },
  {
    ...
    definition:
      "도시지역 외 지구단위계획구역에서는 해당 용도지역·개발진흥지구에 적용되는 건폐율의 150% 이내, 용적률의 200% 이내에서 완화 적용할 수 있지만 건축물 높이제한은 120%가 아니라 별도 기준으로 완화되며, 계획관리지역에 지정된 개발진흥지구에서는 건축물의 용도·종류·규모 제한을 완화할 수 있고, 계획관리지역 외의 지역에 지정된 개발진흥지구에서는 완화 적용 시에도 아파트·연립주택이 허용되지 않는다.",
    intuition:
  ...
  },
  {
    ...
    pitfalls:
      "다른 법률에서 도시·군관리계획 결정을 의제하면 입지규제최소구역 지정 절차도 생략할 수 있다고 착각하기 쉽지만, 이 경우에도 국토계획법에 따른 절차를 따라야 한다.",
    example:
      "도시·군관리계획의 결정권자는 도시·군기본계획에 따른 도심·부도심 또는 생활권의 중심지역과 그 주변지역의 전부 또는 일부를 입지규제최소구역으로 지정할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "성장관리방안에는 기반시설의 배치와 규모에 관한 사항이 포함되어야 하며(포함되지 않을 수 있다는 서술은 틀림), 도시·군관리계획상 시가화 용도지역은 성장관리방안의 수립 대상지역이 아니고, 계획관리지역에서 경관계획을 포함하는 성장관리방안을 수립한 경우에는 50% 이하의 범위에서 조례로 건폐율을 정할 수 있다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "도시혁신구역과 복합용도구역으로 지정되면 「건축법」 제69조에 따른 특별건축구역으로 지정된 것으로 보지만, 시가화조정구역과 도시자연공원구역은 이러한 의제 효과가 없다.",
    intuition:
  ...
  },
  {
    ...
    example:
      "재해복구를 위한 응급조치로서 하는 공작물의 설치는 도시·군계획사업에 의한 행위가 아니더라도 개발행위허가를 받지 아니하여도 된다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "비행정청이 개발행위허가를 받은 경우 용도 폐지되는 기존 공공시설이 전부 무상 귀속된다고 착각하기 쉽지만, 실제로는 새로 설치한 시설의 설치비용 범위 안에서만 무상 양도된다.",
    example:
      "개발행위허가를 받은 자가 행정청이 아닌 경우, 개발행위로 용도가 폐지되는 공공시설은 새로 설치한 공공시설의 설치비용에 상당하는 범위에서 개발행위허가를 받은 자에게 무상으로 양도될 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "시장·군수가 개발밀도관리구역을 변경할 때에도 지방도시계획위원회 심의를 거쳐야 하고, 기반시설부담구역의 지정고시일부터 1년이 되는 날까지(2년이 아님) 기반시설설치계획을 수립하지 않으면 그 1년이 되는 날의 다음 날에 지정이 해제되며, 기반시설설치비용 납부의무자는 사용승인 신청 시까지(7일이 아님) 비용을 내야 하고, 전년도 개발행위허가 건수가 전전년도 대비 20% 이상 증가한 지역은 기반시설부담구역으로 지정해야 하며, 개발밀도관리구역에서는 용적률의 최대한도의 50% 범위에서 용적률을 강화한다.",
    intuition:
    ...
    example:
      "해당 지역의 전년도 개발행위허가 건수가 전전년도 개발행위허가 건수보다 20퍼센트 이상 증가한 지역에 대하여는 기반시설부담구역으로 지정하여야 한다.",
    questionRefs: [
  ...
  // ───────── 주택법 ─────────
  {
    ...
    definition:
      "주택단지는 철도·폭 20m 이상의 일반도로·고속도로·자동차전용도로, 폭 8m 이상의 도시계획예정도로에 의해 분리되며, 국민주택은 국가·지자체·LH·지방공사가 건설하거나 국가·지자체 재정 또는 주택도시기금의 지원을 받아 건설·개량하는 주거전용면적 85㎡ 이하(수도권 제외 읍·면지역은 100㎡ 이하)의 주택을 말하고, 부대시설·복리시설·준주택의 범위가 구체적으로 정해져 있다.",
    intuition:
    ...
    pitfalls:
      "폭 10m의 일반도로나 도시계획예정도로가 주택단지 분리기준이라고 착각하기 쉽지만, 일반도로는 폭 20m 이상이어야 하고 도시계획예정도로는 폭 8m 이상(10m 포함)이면 된다 — 두 기준의 폭 요건이 다르다는 점과, 국민주택 자금지원에 '50% 이상'과 같은 하한 비율이 없다는 점을 혼동하지 않도록 주의한다.",
    example:
      "폭 8미터의 도시계획예정도로로 분리된 두 개의 대지에 각각 주택을 건설하는 경우, 이 두 대지는 각각 별개의 주택단지로 본다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "지역주택조합을 설립하려면 주택건설대지의 80% 이상에 해당하는 토지의 사용권원을 확보해야 하고, 조합원은 주택건설 예정세대수의 50% 이상(조합원 10명 이상)으로 구성해야 하며, 조합원 수가 결원으로 예정세대수의 50% 미만이 되면 그 범위에서 신규가입·충원할 수 있다.",
    intuition:
    ...
    example:
      "지역주택조합의 조합원 수가 사망·자격상실 등으로 결원이 생겨 주택건설 예정세대수의 50% 미만이 된 경우, 그 결원 범위에서 새로운 조합원을 충원할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "사업계획승인권자는 사업주체의 신청을 받아 정당한 사유가 없으면 신청받은 날부터 60일 이내에 사업계획 승인 여부를 통보하여야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "공동주택 리모델링을 하려는 자는 입주자·사용자·관리주체가 동(棟)의 증축형 리모델링을 하는 경우 등 법정 요건에 따라 허가를 받아야 하며, 리모델링 결의에는 주택단지 전체 또는 동별로 구분소유자 및 의결권의 일정 비율 이상의 동의가 필요하다.",
    intuition:
      "리모델링은 증축 범위(세대수 증가 15% 이내 등)와 동의율 요건이 핵심이며, 안전진단·안전성 검토 절차가 함께 출제된다는 점을 기억해두면 된다.",
    keyPoints: [
      "리모델링은 대수선, 세대수 증가형(전체 세대수의 15% 이내 증축) 등으로 구분되며, 증축형 리모델링을 하려면 안전진단을 실시해야 한다.",
      "주택단지 전체를 리모델링하려면 주택단지 전체 구분소유자와 의결권의 일정 비율 이상, 동을 리모델링하려면 해당 동 구분소유자와 의결권의 일정 비율 이상의 동의를 받아야 한다.",
    ...
    pitfalls:
      "리모델링 동의율을 재건축·재개발의 동의율과 혼동하기 쉬우나, 주택법상 리모델링은 주택단지 전체/동별 동의 요건이 별도로 규정되어 있다는 점에 유의해야 한다.",
    example:
      "공동주택의 소유자가 세대수를 증가하는 증축형 리모델링을 하려는 경우, 리모델링을 하기 전에 해당 건축물의 안전진단을 실시하여야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "등록사업자가 발행한 주택상환사채는 등록사업자의 등록이 말소된 경우에도 사채권자에 대한 상환 의무에 영향을 미치지 아니한다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "국가·지자체·LH·지방공사도 일정 규모 이상 주택건설사업 시 등록해야 한다고 오해하기 쉽지만, 이들 공공 주체는 등록 의무의 예외 대상이다.",
    example:
      "한국토지주택공사가 연간 20호 이상의 단독주택 건설사업을 시행하는 경우에도 국토교통부장관에게 별도로 등록할 필요가 없다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "세대구분형 공동주택은 구분된 공간마다 별도의 욕실·부엌·현관을 설치하되 하나의 세대로 산정되며, 도시형생활주택은 300세대 미만의 국민주택규모 주택으로 일정한 건설·형태 제한을 받고, 토지임대부 분양주택은 토지의 소유권은 시행자가, 건축물의 소유권은 주택을 분양받은 자가 각각 갖는다.",
    intuition:
    ...
    keyPoints: [
      ...
      "토지임대부 분양주택은 토지의 소유권은 시행자가 보유하고 건축물 및 복리시설의 소유권은 주택을 분양받은 자가 취득하는 방식이며, 임대차기간은 40년 이내로 하되 갱신할 수 있다.",
    ],
    pitfalls:
      "토지임대부 분양주택에서 토지와 건물을 모두 분양받은 자가 소유한다고 오해하기 쉽지만, 토지 소유권은 시행자에게 그대로 남는다는 점이 핵심이다.",
    example:
      "토지임대부 분양주택을 분양받은 자는 건축물 및 복리시설에 대한 소유권을 취득하지만, 그 대지의 소유권은 취득하지 못한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "사용검사 후 매도청구로 소유권을 회복한 대지에 대해서는 종전 소유자가 사용검사 신청 전에 매도청구 대상 대지에 대한 소송을 제기한 경우 등 법정 사유가 있으면 사업주체가 해당 주택 등의 소유권을 회복할 수 있고, 국토교통부장관 등이 조합설립인가 취소·주택건설사업 등록말소 등을 하려면 청문을 실시해야 하며, 공급질서교란행위(증서 등의 양도·양수 등)를 한 자는 주택의 공급을 신청할 수 있는 지위를 무효로 하거나 제한할 수 있다.",
    intuition:
    ...
    pitfalls:
      "이 묶음의 각 항목은 서로 다른 조문에서 나온 개별 규정이므로, 하나의 논리로 묶어 암기하려 하지 말고 항목별 키워드(사용검사·청문·공급질서교란·권한위임·조정대상지역)로 따로 정리하는 것이 안전하다.",
    example:
      "공급질서교란행위로 적발되어 주택공급계약이 취소된 자는 그 위반행위로 취득하거나 취득하려 하였던 주택의 공급을 신청할 수 있는 지위를 잃는다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "전매제한기간은 주택의 수급 상황·투기 우려 등을 고려해 지역별로 달리 정할 수 있으며, 수도권 공공택지 외의 택지에서 건설·공급되는 주택은 소유권 이전 금지를 소유권 등기에 부기등기해야 하고, 세대원 전원의 해외 이주·2년 이상 해외 체류, 상속에 따른 세대원 전원 이전(사업주체 동의 필요), 국가에 대한 채무불이행으로 인한 공매(사업주체 동의 불요) 등의 경우에는 예외적으로 전매할 수 있다.",
    intuition:
      "전매제한 예외 사유는 '사업주체의 동의가 필요한 경우(해외 체류·상속 이전)'와 '동의 없이도 가능한 경우(공매)'로 나뉘므로, 이 구분을 정확히 기억하는 것이 핵심이다.",
    keyPoints: [
      ...
      "국가에 대한 채무를 이행하지 못해 공매가 시행되는 경우에는 사업주체의 동의 없이도 전매할 수 있다(동의가 필요하다는 서술은 틀림).",
    ],
    pitfalls:
  ...
  },
  {
    ...
    definition:
      "한국토지주택공사가 총지분의 50%를 초과해 출자한 부동산투자회사가 사업주체로 입주자를 모집하는 경우 시장·군수·구청장의 승인이 필요 없고, 사업주체는 마감자재 목록표를 입주자 요구 시 공개해야 하며 부득이한 사유로 마감자재를 다르게 시공하는 경우 당초 자재와 같은 질 이상의 자재로 설치해야 하고, 투기과열지구에서 공급된 주택의 입주자로 선정된 지위는 상속의 경우를 제외하고 매매할 수 없다.",
    intuition:
    ...
    example:
      "사업주체가 일반인에게 공급하는 공동주택 중 공공택지에서 공급하는 주택에는 분양가상한제가 적용되지만, 도시형 생활주택을 공급하는 경우에는 분양가상한제가 적용되지 않는다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "투기과열지구로 지정하는 날이 속하는 달의 바로 전 달부터 소급하여 주택공급이 있었던 2개월 동안 해당 지역에서 공급되는 주택의 월평균 청약경쟁률이 모두 5대 1을 초과하거나 국민주택규모 주택의 월평균 청약경쟁률이 모두 10대 1을 초과한 곳은 투기과열지구로 지정될 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "주택의 사용검사 후 대지 소유권을 회복한 자가 있는 경우, 주택소유자들은 그 대지의 면적이 주택단지 전체 대지면적의 100분의 5 미만인 경우에 한해 그 소유자에게 해당 토지를 시가로 매도할 것을 청구할 수 있으며, 매도청구를 하려면 그 사실을 안 날부터 2년 이내에 해야 한다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "한국토지주택공사와 등록사업자는 주택상환사채를 기명증권으로 발행하며, 사채권자 명의변경은 취득자의 성명·주소를 사채원부에 기록하는 방법으로 하고, 발행자는 발행조건에 따라 주택을 건설해 사채권자에게 상환해야 하며, 등록사업자의 등록이 말소되더라도 이미 발행한 주택상환사채의 효력에는 영향이 없고, 납입금은 주택건설자재의 구입 등 해당 주택건설사업에 필요한 용도로 사용할 수 있다.",
    intuition:
    ...
    pitfalls:
      "주택상환사채를 무기명증권으로 착각하기 쉽지만 실제로는 기명증권이며, 발행규모·상환기간 기준(최근 3년, 상환기간 3년 이내)을 5년으로 잘못 기억하지 않도록 유의해야 한다.",
    example:
      "등록사업자의 등록이 말소된 경우에도 그 등록사업자가 발행한 주택상환사채의 효력에는 영향을 미치지 아니한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "공동주택 리모델링은 시장·군수·구청장의 허가를 받아야 하고 동별로도 할 수 있으며, 대수선을 포함한 모든 유형의 리모델링을 하려는 자는 안전진단을 요청해야 하고, 주택단지 전체를 리모델링하려는 주택조합 설립에는 전체 구분소유자와 의결권의 각 3분의 2 이상 결의(과반수가 아님)가 필요하며, 12층인 기존 건축물의 수직증축형 리모델링은 2개 층까지 증축할 수 있다.",
    intuition:
    ...
    pitfalls:
      "주택단지 전체 리모델링을 위한 조합 설립 동의요건을 '과반수'로 착각하기 쉽지만, 실제로는 구분소유자와 의결권의 각 3분의 2 이상이 필요하다.",
    example:
  ...
  },
  {
    ...
    definition:
      "공공택지 외 택지에서 건설·공급되는 분양가상한제 적용주택의 분양가격이 인근지역주택매매가격의 80% 이상 100% 미만이고 보유기간이 3년 이상 4년 미만이면 한국토지주택공사는 매입비용의 25%에 인근지역주택매매가격의 75%를 더한 금액으로 우선 매입하며, 도시형 생활주택은 분양가상한제 적용주택이 아니고, 공공택지에서 공급하는 분양가상한제 적용주택의 입주자 모집공고에는 택지비·건축비 등 분양가격을 공시해야 하되 간접비는 공시 항목에서 제외된다.",
    intuition:
    ...
    example:
      "공공택지 외의 택지에서 건설·공급되는 주택의 분양가격이 인근지역주택매매가격의 80퍼센트 이상 100퍼센트 미만이고 보유기간이 3년 이상 4년 미만인 경우, 한국토지주택공사의 매입금액은 매입비용의 25퍼센트에 인근지역주택매매가격의 75퍼센트를 더한 금액이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "사업주체(한국토지주택공사 포함)는 시장·군수·구청장의 사용검사를 받아야 하며 사용검사는 신청일부터 15일 이내에 해야 하고, 사업주체가 파산 등으로 사용검사를 받을 수 없으면 시공보증자·시공자·입주예정자가 사용검사를 받을 수 있으며(무단거주가 아닌 입주예정자 대표회의가 신청 시 하자보수보증금 예치 필요), 임시 사용승인은 동별·세대별·구획별로 받을 수 있다.",
    intuition:
      "사용검사 문제는 '누가 신청할 수 있는지(원칙: 사업주체, 예외: 시공보증자·시공자·입주예정자)'와 '기한(신청일부터 15일)', '임시사용승인의 단위(동별·세대별·구획별)'를 조합해 출제한다.",
    keyPoints: [
      "사용검사는 그 신청일부터 15일 이내에 해야 하며, 한국토지주택공사가 사업주체인 경우에도 시장·군수·구청장의 사용검사를 받아야 한다.",
      "사업주체가 파산 등으로 사용검사를 받을 수 없는 경우에는 해당 주택의 시공을 보증한 자, 시공자 또는 입주예정자가 대통령령으로 정하는 바에 따라 사용검사를 받을 수 있다.",
    ...
    pitfalls:
      "한국토지주택공사가 사업주체인 경우 자체적으로 사용검사를 완결한다고 착각하기 쉽지만, 한국토지주택공사도 시장·군수·구청장의 사용검사를 받아야 한다.",
    example:
      "사업주체가 파산 등으로 사용검사를 받을 수 없는 경우에는 해당 주택의 시공을 보증한 자, 해당 주택의 시공자 또는 입주예정자가 대통령령으로 정하는 바에 따라 사용검사를 받을 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "입주자저축이란 국민주택과 민영주택을 공급받기 위해 가입하는 주택청약종합저축을 말하며, 한 사람이 한 계좌만 가입할 수 있고, 국토교통부장관으로부터 입주자저축정보 제공 요청을 받은 취급기관의 장은 「금융실명거래 및 비밀보장에 관한 법률」에도 불구하고 이를 제공해야 하며, 이 경우 정보 제공사실을 명의인에게 통보하지 않을 수 있다.",
    intuition:
      "입주자저축 문제는 '정의(주택청약종합저축)', '1인 1계좌 원칙', '금융실명법의 예외로서 정보제공 의무'를 조합해 출제하며, 통보의무 면제라는 예외가 핵심 함정이다.",
    keyPoints: [
      ...
      "입주자저축정보를 제공한 입주자저축취급기관의 장은 명의인이 요구하더라도 정보 제공사실을 통보하지 않을 수 있다.",
  ...
  },
  {
    ...
    definition:
      "공동주택 품질점검단은 시장·군수·구청장이 아니라 시·도지사가 설치·운영하며, 사업주체가 품질점검단의 점검에 따르지 않거나 기피·방해하면 과태료 부과대상이고, 품질점검단은 점검 종료일부터 5일 이내에 점검결과를 사용검사권자에게 제출해야 하며, 사용검사권자는 그 점검결과를 사용검사가 있은 날부터 5년 이상 보관해야 한다.",
    intuition:
      "품질점검단 관련 숫자(제출기한 5일, 보관기간 5년, 위원 경력요건)를 정확히 암기하고, 설치·운영 주체가 '시·도지사'라는 점을 시장·군수·구청장과 혼동하지 않는 것이 핵심이다.",
    keyPoints: [
      ...
      "사용검사권자는 품질점검단으로부터 제출받은 점검결과를 사용검사가 있은 날부터 5년 이상 보관해야 한다(3년이 아님).",
  ...
  // ───────── 농지법 ─────────
  {
    ...
    definition:
      "농지 해당 여부는 법적 지목이 아니라 토지의 현실적인 이용 상황에 따라 판단하며(지목이 과수원이라도 실제 경작지면 농지), 다년생식물 재배지·농지개량시설 부지(양·배수시설 등)도 농지에 포함되지만 조경목적 관상수 묘목 재배지는 농지가 아니고, 농업인은 1천㎡ 이상 농지 경작(80일 이상 종사), 대가축 2두·중가축 10두·소가축 100두·가금 1천수 이상 사육, 연간 120일 이상 축산업 종사 등의 기준을 충족해야 한다.",
    intuition:
      "농지·농업인의 정의는 '지목이 아닌 실제 이용 상황'이라는 대원칙과, 농업인 인정 기준(면적·일수·사육두수)의 정확한 숫자 조합을 함께 요구하므로 두 축을 분리해 암기해야 한다.",
    keyPoints: [
      ...
      "소가축(양·돼지·염소 등) 100두 이상 또는 대가축(소·말 등) 2두 이상을 사육하며 1년 중 120일 이상 축산업에 종사하는 개인은 농업인에 해당하지만, 소가축 80두·150일 종사만으로는 두수 기준(100두)에 미달해 농업인 요건을 충족하지 못한다.",
      "1천㎡ 이상의 농지에서 농작물을 경작하면서 1년 중 90일 이상 농업에 종사하는 개인은 농업인에 해당하며, 3,000㎡ 농지에서 80일 종사한 경우 면적 기준(1천㎡ 이상)은 충족하지만 일수 기준에 따라 별도 판단이 필요하다.",
      ...
      "꿀벌은 10군 이상 사육하면 농업인 요건(가축사육 기준)을 충족하지만, 가금 500수(기준 1천수 미달)나 농산물 연간 판매액 100만원(기준 120만원 미달), 비닐하우스 300㎡의 다년생식물 재배(기준 330㎡ 미달)만으로는 농업인 요건에 미달한다.",
    ],
    pitfalls:
      "지목만 보고 농지 여부를 판단하는 실수를 하기 쉽다 — 실제 이용 상황이 우선 기준이며, 조경목적 관상수 재배지처럼 농업생산과 무관한 재배지는 농지가 아니다.",
    example:
  ...
  },
  {
    ...
    intuition:
      "위탁경영 가능 사유는 법정 목록(징집·국외여행 3개월 이상·질병 3개월 이상·공직취임·법인청산·이용증진사업)에 열거된 것에 한정되며, '노동력 부족'이라는 일반적 사유나 기간·장소 기준에 미달하는 경우는 제외된다는 원�칙을 기억해야 한다.",
    keyPoints: [
    ...
    example:
      "「병역법」에 따라 징집되거나 3개월 이상의 국외여행 중인 농지 소유자, 3개월 이상의 치료가 필요한 부상으로 자경할 수 없는 농지 소유자는 소유 농지의 경영을 위탁할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "임대차계약은 등기가 없는 경우에도 임차인이 농지 소재지를 관할하는 시·구·읍·면의 장의 확인을 받고 해당 농지를 인도받은 경우에는 그 다음 날부터 제3자에 대하여 효력이 생긴다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "시효의 완성, 공유 농지의 분할, 농업법인의 합병, 국가·지방자치단체의 농지 소유, 상속(유증 포함)으로 농지를 취득하는 경우에는 농지취득자격증명을 발급받지 않고도 농지를 취득할 수 있지만, 주말·체험영농을 목적으로 농업진흥지역 외의 농지를 취득하는 경우에는 농지취득자격증명을 발급받아야 한다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "농업진흥지역은 특별시의 녹지지역을 제외한 지역(특별시의 관리지역, 광역시의 관리지역·농림지역, 군의 자연환경보전지역 등)에 지정할 수 있으며, 특별시의 녹지지역에는 지정할 수 없다.",
    intuition:
      "농업진흥지역 지정 제외 대상은 '특별시의 녹지지역' 하나로 좁혀 기억하면 되며, 나머지 관리지역·농림지역·자연환경보전지역은 소속 행정구역(특별시·광역시·군)과 무관하게 모두 지정 가능하다.",
    keyPoints: [
  ...
  },
  {
    ...
    definition:
      "농지대장은 모든 농지에 대해 필지별로 작성하는 것은 아니며(농지가 아니게 된 일부 예외 존재), 전산정보처리조직으로 처리한 농지대장 파일도 농지대장으로 보고, 시·구·읍·면의 장은 관할구역 내 농지가 전용허가 등으로 농지에 해당하지 않게 되면 그 농지대장을 따로 편철해 5년간 보존해야 하며, 농지소유자·임차인은 임대차계약 체결일부터 60일 이내에 농지대장의 변경을 신청해야 하고, 농지대장의 열람은 관계공무원의 참여하에 해당 관서 사무소 안에서 해야 한다.",
    intuition:
      "농지대장 조문은 '보존기간(5년)'과 '변경신청 기한(60일)'이라는 두 숫자를 정확히 구분해 암기하는 것이 핵심이며, 두 숫자를 서로 바꿔치기하는 오답이 반복된다.",
    keyPoints: [
      "농지대장은 모든 농지에 대해 필지별로 작성하는 것은 아니다(예외적으로 작성하지 않는 경우가 있음).",
      "농지대장에 적을 사항을 전산정보처리조직으로 처리하는 경우 그 농지대장 파일은 농지대장으로 본다.",
      "시·구·읍·면의 장은 관할구역 안의 농지가 농지전용허가 등으로 농지에 해당하지 않게 된 경우 그 농지대장을 따로 편철하여 5년간 보존해야 한다(10년이 아님).",
