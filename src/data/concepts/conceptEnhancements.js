const conceptEnhancements = {
  ...
  'building-area-calculation-method': {
    ...
    floor: [{ case: '부분별 층수가 다름', rule: '가장 많은 층수' },{ case: '층 구분이 명확하지 않음', rule: '높이 4m마다 1개 층' },{ case: '1층 전체 필로티 높이', rule: '높이 제한 산정 시 필로티 층고 제외' }],
  ...
  'posting-obligation': {
    kind: 'posting-obligation-include-exclude', amended: true, summary: '현행 게시의무는 등록·자격·보증·요율표·사업자등록증이 대상이고, 실무교육 수료확인증은 제외된다. 사업자등록증은 2021.12.31. 개정으로 추가되었다.',
    include: ['중개사무소등록증', '공인중개사자격증(대표자 및 고용된 소속공인중개사 모두)', '손해배상책임보장 증명서류', '중개보수·실비 요율 및 한도액표', '사업자등록증(2021.12.31. 이후)'],
    exclude: ['실무교육 수료확인증'],
    caution: '실무교육 수료확인증은 게시 대상이 아니다. 2020·제31회 기출에서는 당시 법상 사업자등록증이 게시 비대상이었으므로, 그 문항 정답키를 현행으로 덮어쓰면 안 된다.',
    sources: [
      { label: '공인중개사법 제17조', note: '중개사무소의 게시의무', href: 'https://www.law.go.kr/법령/공인중개사법/제17조' },
      { label: '공인중개사법 시행규칙 제10조', note: '게시사항(사업자등록증 포함·2021.12.31. 개정)', href: 'https://www.law.go.kr/법령/공인중개사법시행규칙/제10조' },
    ],
  },
  ...
  'asset-securitization-law-and-pf': {
    kind: 'securitization-structure-board', amended: true, summary: '유동화 절차는 "자산을 누구에게, 어떻게 넘기는가"와 "그 유동화가 어느 법에 근거하는가"라는 두 축으로 정리된다.',
    structure: [
      { item: '유동화전문회사(SPC) 형태', rule: '기출 당시 유한회사만 — 2024.1.12. 시행 개정으로 주식회사 또는 유한회사(자산유동화법 제17조). 「자본금 10억 미만」은 서면 주주총회 특례(제19조) 범위이지 설립 제한이 아니다' },
    ...
    caution: 'ABCP의 반복적 유동화 등록기관을 금융감독원으로 착각하기 쉽지만, 실제 등록기관은 금융위원회다. 현행 SPC를 「유한회사만」으로 단정하면 틀린다.',
    sources: [
      { label: '자산유동화에 관한 법률 제17조', note: '주식회사 또는 유한회사', href: 'https://www.law.go.kr/법령/자산유동화에관한법률/제17조' },
    ],
  },
  ...
  'transaction-report-additional-items': {
    kind: 'fund-plan-threshold-gate', amended: true, summary: '자금조달·입주계획서는 투기과열지구·조정대상지역은 금액과 무관하게, 그 밖의 지역은 6억원 이상만 요구된다는 기준선이 핵심이다.',
    gates: [
    ...
    caution: '자금조달·입주계획서를 매도인·매수인이 공동으로 서명·날인해 제출한다고 착각하기 쉽지만, 실제로는 매수인이 단독으로 작성·제출한다. 옛 기출의 투기과열 3억 문턱은 개정 전 기준이다.',
    sources: [
  ...
  'basic-survey-environmental-review-exemption': {
    kind: 'survey-exemption-dual-list', summary: '기초조사·환경성 검토 생략 목록은 갈래가 달라도, 나대지 기준은 둘 다 구역면적 2% 미달이다.',
    environmentalReview: { threshold: '제1호 사유를 끌어오므로 나대지 2% 미달 포함', excludedCases: '도시개발사업 등은 환경성 검토 생략 사유로 따로 열거되지 않음' },
    basicSurvey: ['나대지면적 구역면적 2% 미달', '도시·군계획시설 결정의 해제', '지구단위계획구역이 상업지역·연접지역(도심지)', '용도지구 폐지 후 지구단위계획으로 대체', '정비·관리 목적 구역에서 너비 12m 이상 도로 설치계획 없음'],
    trap: '나대지면적 3%(또는 10%)를 기초조사 생략 기준으로 외우면 틀린다. 법은 2% 미달만 본다.',
    caution: '목록 갈래는 달라도 나대지 숫자는 하나다. 기초조사·환경성 검토 모두 2% 미달이다.',
    sources: [
      { label: '국토계획법 시행령 제21조', note: '도시·군관리계획 입안을 위한 기초조사 면제사유 등', href: 'https://www.law.go.kr/법령/국토의계획및이용에관한법률시행령/제21조' },
    ],
  },
  ...
  'growth-management-plan-designation': {
    kind: 'growth-plan-procedure-relaxation-board', summary: '성장관리계획구역은 도시지역이 아닌 지역만을 대상으로 하므로 공업지역은 제외되며, 지정 절차와 열람기간(14일 이상)·완화 숫자를 정확히 암기해야 한다.',
    ...
    caution: '건폐율 완화 대상 지역과 용적률 완화 대상 지역(계획관리지역)을 서로 바꿔 기억하기 쉽다. 2022년 기출(33회 43번)의 오답 선지도 「보전관리지역 용적률 125% 완화」처럼 대상 지역을 바꿔 놓은 것이었고, 보전관리지역·보전녹지지역은 두 완화 어디에도 들지 않는다.',
    sources: [
  ...
  'reconstruction-safety-diagnosis': {
    kind: 'safety-diagnosis-board', amended: true, summary: '재건축 진단(구 안전진단)은 "실시 시기", "제외 대상", "심사 항목", "결과의 처리"로 나뉘어 출제된다. 현행 명칭은 재건축진단이다.',
    criteriaLabels: { situation: '항목', marker: '진단 기준' },
    timing: '단계별 정비사업추진계획에 따라 정비예정구역별 정비계획의 수립시기가 도래하면 실시(옛 기출 기준). 현행은 2025.6.4.부터 「재건축진단」으로 명칭·시기 등이 조정됨',
    exempt: '진입도로 등 기반시설 설치를 위해 불가피하게 정비구역에 포함된 것으로 인정되는 주택단지 내 건축물은 제외 가능',
    criteria: ['구조안전성', '건축마감', '설비노후도', '주거환경 적합성'],
    reportRule: '시장·군수는 안전진단(재건축진단)결과보고서를 국토교통부장관에게 제출할 의무는 없음',
    caution: '결과보고서를 국토교통부장관에게 반드시 제출해야 한다고 오해하기 쉽지만, 그런 의무는 규정되어 있지 않다. 옛 기출의 「안전진단」은 현행 「재건축진단」과 같은 절차의 옛 이름이다.',
    sources: [
      { label: '도시정비법 제12조', note: '재건축사업의 재건축진단(구 안전진단)', href: 'https://www.law.go.kr/법령/도시및주거환경정비법/제12조' },
    ],
  },
  ...
  'combined-building': {
    kind: 'combined-building-scope-board', summary: '결합건축이 가능한 지역·구역에는 상업지역·역세권개발구역·건축협정구역·특별건축구역·리모델링 활성화구역이 포함되지만 특별가로구역은 제외되며, 협정서에는 조정된 용적률 등을 적어야 하되 지방세 납세증명서는 기재사항이 아니다.',
    scope: { in: ['상업지역', '역세권개발구역', '건축협정구역', '특별건축구역', '리모델링 활성화구역'], out: '특별가로구역 (결합건축 대상 아님)' },
    ...
    caution: '리모델링 활성화구역을 결합건축 대상에서 빠뜨리거나, 특별가로구역을 대상에 넣는 함정에 유의해야 한다. 지방세 납세증명서는 협정서 기재사항이 아니다.',
    sources: [
      { label: '건축법 제77조의15', note: '결합건축 대상지', href: 'https://www.law.go.kr/법령/건축법/제77조의15' },
    ],
  },
  'special-building-zone': {
    kind: 'special-zone-exemption-filter', summary: '특별건축구역에서 국가가 건축하는 건축물은 대지의 조경(제42조)과 대지 안의 공지(제58조) 등을 적용하지 않을 수 있지만, 대지와 도로의 관계(제44조)·대지의 분할 제한(제57조)은 그대로 적용된다.',
    exemptable: ['대지의 조경 (제42조)', '대지 안의 공지 (제58조)'],
    notExemptable: ['대지와 도로의 관계 (제44조)', '대지의 분할 제한 (제57조)'],
