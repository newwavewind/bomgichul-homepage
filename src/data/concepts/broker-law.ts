...
const concepts: Concept[] = [
  ...
  },
  {
    ...
    example:
      "재건축조합원이 관리처분계획 인가 전 가지는 아파트 입주권은 아직 특정 물건에 대한 권리로 확정되지 않아 중개대상물이 아니다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "등록관청은 중개사무소 개설등록 신청을 받은 날부터 7일 이내에 신청인에게 서면으로 통지해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "법인이 중개사무소를 개설하려면 상법상 회사는 자본금 5천만원 이상, 대표자는 공인중개사이어야 하고 대표자를 포함한 임원·사원의 3분의 1 이상은 공인중개사이어야 하며, 대표자·임원·사원 전원과 분사무소 책임자가 실무교육을 받아야 한다.",
    intuition:
      "법인 등록기준은 자본·인력(공인중개사 비율)·교육이수라는 세 축으로 나뉘므로, 숫자(5천만원, 3분의 1)가 바뀌어 나오는 오답을 가려내는 것이 핵심이다.",
    keyPoints: [
      "상법상 회사인 경우 자본금은 5천만원 이상이어야 하지만, 이는 상법상 회사에 대한 기준이며 협동조합기본법상 조합에는 별도 자본금 기준이 적용된다.",
      "대표자는 공인중개사이어야 하고, 대표자를 포함한 임원 또는 사원(합명·합자회사의 무한책임사원)의 3분의 1 이상은 공인중개사이어야 한다(2분의 1이 아님).",
    ...
    pitfalls:
      "공인중개사 비율 요건을 '2분의 1 이상'으로 착각하기 쉽지만, 실제로는 대표자를 포함해 '3분의 1 이상'이 공인중개사여야 한다.",
    example:
      "상법상 주식회사가 중개사무소를 개설하려면 자본금이 5천만원 이상이어야 하고, 대표자는 반드시 공인중개사여야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "파산선고를 받고 복권되지 않은 자, 금고 이상의 형의 집행유예를 받고 그 유예기간 중에 있는 자, 자격증을 대여해 자격이 취소된 후 3년이 지나지 않은 자, 피성년후견인·피한정후견인 등은 중개사무소 개설등록의 결격사유에 해당한다.",
    intuition:
    ...
    keyPoints: [
      ...
      "형의 선고유예를 받은 자는 결격사유가 아니며, 금고 이상의 형의 집행유예를 받고 그 유예기간 중에 있는 자만 결격사유에 해당한다.",
    ...
    example:
      "형의 선고유예를 받은 자는 중개사무소 개설등록의 결격사유자가 아니므로 등록을 신청할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "법인인 개업공인중개사가 분사무소에서 사용할 인장을 등록하려면, 상업등기규칙에 따라 법인의 대표자가 보증하는 인장을 등록해야 하며 인감증명서 제출로 대신할 수 없다.",
  },
  {
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "중개사무소를 이전·폐업신고하거나 개설등록 취소처분을 받은 경우에는 지체 없이 간판을 철거해야 하지만, 6개월을 초과하는 휴업신고를 한 경우는 철거 사유가 아니다.",
      "명칭 규정 위반은 개설등록의 취소사유가 아니라 100만원 이하의 과태료 부과사유다.",
    ],
    pitfalls:
      "6개월을 초과하는 휴업신고도 간판 철거 사유라고 착각하기 쉽지만, 휴업은 사무소를 유지한 채 일시 중단하는 것이므로 철거 사유가 아니다.",
    example:
      "개업공인중개사가 중개사무소의 개설등록 취소처분을 받은 경우, 지체 없이 사무소의 간판을 철거해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "개업공인중개사가 중개대상물을 표시·광고할 때는 중개사무소의 명칭·소재지·연락처와 개업공인중개사의 성명을 명시해야 하며, 존재하지 않거나 거래할 수 없는 대상물에 대한 광고나 가격을 과장하는 광고 등 부당한 표시·광고는 금지되고, 국토교통부장관은 인터넷 표시·광고를 모니터링한다.",
    intuition:
      "표시·광고 규제는 '누가 광고를 냈는지 특정할 수 있게'(명시사항)와 '광고 내용이 실체와 다르지 않게'(부당광고 금지)라는 두 축으로 이해하면 된다.",
    keyPoints: [
      "표시·광고에 명시해야 할 '중개사무소·개업공인중개사에 관한 사항'은 중개사무소의 명칭·소재지·연락처와 개업공인중개사의 성명이며, 소속공인중개사나 중개보조원의 성명은 명시 대상이 아니다.",
    ...
    pitfalls:
      "표시·광고 내용을 사실과 다르게 거짓으로 표시·광고한 것을 신고하면 포상금 지급대상이 된다고 착각하기 쉽지만, 이는 포상금 지급대상 목록에 없는 행위다.",
    example:
      "인터넷으로 매물을 광고할 때도 중개사무소의 명칭과 소재지·연락처, 개업공인중개사의 성명은 반드시 표시해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "부동산중개 명칭을 무단 사용한 자의 벌칙을 3년 이하 징역·3천만원 이하 벌금으로 착각하기 쉽지만, 실제로는 1년 이하의 징역 또는 1천만원 이하의 벌금이다.",
    example:
      "법인 개업공인중개사의 분사무소 안에는 그 분사무소설치신고확인서 원본을 게시해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "법인인 개업공인중개사는 주택 및 상업용 건축물의 분양대행·관리대행, 부동산의 이용·개발에 관한 상담, 중개업의 경영기법·경영정보 제공, 주거이전에 부수되는 용역의 알선, 국세징수법상 공매대상 부동산의 취득알선·입찰신청대리 등을 겸업할 수 있지만, 주택의 임대업 자체, 토지(주택용지)의 분양대행, 금융의 알선, 공제업무의 대행, 동산에 대한 입찰신청대리는 겸업범위에 해당하지 않는다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "중개사무소를 이전한 때에는 이전한 날부터 10일 이내에 이전신고를 해야 하며, 관할지역 외로 이전한 경우에는 이전 후 사무소를 관할하는 등록관청에, 분사무소를 이전한 경우에는 주된 사무소 소재지 관할 등록관청에 신고한다.",
    intuition:
  ...
  },
  {
    ...
    example:
      "개업공인중개사가 질병 요양을 위해 8개월간 휴업하려는 경우, 부득이한 사유가 인정되어 6개월을 초과하는 휴업도 가능하다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "개업공인중개사는 소속공인중개사·중개보조원을 고용하려면 업무개시 전에 미리 등록관청에 신고해야 하고, 고용관계가 종료된 경우에도 종료일부터 10일 이내에 신고해야 하며, 이들의 업무상 행위는 고용한 개업공인중개사의 행위로 보되 형사책임(징역형)까지 개업공인중개사에게 승계되지는 않는다.",
    intuition:
    ...
    example:
      "중개보조원이 과실로 거래당사자에게 손해를 입힌 경우, 그를 고용한 개업공인중개사뿐만 아니라 중개보조원 본인도 손해배상책임을 질 수 있다.",
  },
  {
  ...
  },
  {
    ...
    example:
      "개업공인중개사가 공제금으로 손해배상을 한 경우, 15일 이내에 공제에 다시 가입하거나 부족액을 보전해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "중개대상물에 근저당권이 설정되어 있다면 그 등기된 채권최고액은 확인·설명해야 하지만, 실제 피담보채무액까지 조사할 의무는 없다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "비주거용 건축물을 확인·설명서[Ⅱ]로 작성할 때는 비선호시설 유무를 기재하지 않는다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "개업공인중개사는 중개가 완성된 때에만 거래계약서를 작성·교부해야 하고 서명 및 날인(서명 또는 날인 중 하나만으로는 부족)해야 하며, 그 원본·사본·전자문서를 5년간 보존해야 하고, 국토교통부장관이 정한 표준서식의 사용은 권장사항일 뿐 강제되지 않는다.",
    intuition:
    ...
    example:
      "공동으로 중개한 개업공인중개사들은 거래계약서에 서명과 날인을 모두 해야 하며, 그중 하나만으로는 부족하다.",
  },
  {
    ...
    definition:
      "전속중개계약은 특정 개업공인중개사 1인에 한하여 중개를 의뢰하는 계약으로, 당사자 간 기간 약정이 없으면 유효기간은 3개월이며, 체결한 개업공인중개사는 부동산거래정보망 등에 중개대상물 정보를 공개하고 2주일에 1회 이상 처리상황을 통지해야 한다.",
    intuition:
    ...
    keyPoints: [
      ...
      "전속중개계약을 체결한 개업공인중개사는 부동산거래정보망 또는 일간신문에 중개대상물 정보를 공개해야 하지만, 의뢰인의 비공개 요청이 있는 사항이나 권리자의 인적사항은 공개해서는 안 된다.",
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "전속중개계약의 유효기간은 다른 약정이 없으면 3개월이고, 3개월 미만으로 약정하면 3개월로 되지만 3개월을 초과하는 약정은 그대로 유효하다(초과할 수 없다는 서술은 틀림).",
    ...
    example:
      "다른 약정 없이 전속중개계약을 2개월로 체결했다면, 그 유효기간은 자동으로 3개월로 늘어난다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "표준서식인 일반중개계약서와 전속중개계약서에는 중개보수 요율표(첨부), 계약의 유효기간, 중개대상물 확인·설명에 관한 사항, 중개보수 과다수령 시 차액 환급 규정이 공통으로 기재되지만, 개업공인중개사의 중개업무 처리상황 통지의무는 전속중개계약서에만 있는 기재사항이다.",
    intuition:
      "두 서식의 차이는 전속중개계약이 의뢰인에게 지우는 추가 의무(정보공개·통지)가 서식에도 그대로 반영된다는 원칙으로 이해하면 된다.",
    keyPoints: [
      "중개보수 요율표(첨부서류), 계약의 유효기간, 중개대상물의 확인·설명에 관한 사항, 중개보수 과다수령 시 차액 환급 규정은 일반·전속중개계약서에 공통으로 기재된다.",
      "개업공인중개사의 중개업무 처리상황에 대한 통지의무는 전속중개계약서에만 있는 기재사항이며, 일반중개계약서에는 없다.",
      "일반중개계약서에는 소유자 및 등기명의인, 은행융자·권리금·제세공과금 등, 거래규제 및 공법상 제한사항은 기재하지 않고, 희망 지역·취득(중개의뢰) 희망가격 등만 기재한다.",
    ],
    pitfalls:
      "소유자 및 등기명의인이나 권리관계 같은 상세정보를 일반중개계약서에도 기재한다고 착각하기 쉽지만, 이는 전속중개계약서에만 기재하는 항목이다.",
    example:
      "주택을 매수하려는 의뢰인이 일반중개계약서를 작성할 때는 희망 지역과 취득 희망가격을 기재하지만, 소유자 및 등기명의인은 기재하지 않는다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "주택의 중개보수는 국토교통부령이 정한 범위 안에서 시·도의 조례로 정하고(중개대상물 소재지와 중개사무소 소재지가 다르면 중개사무소 소재지 관할 조례를 따름), 주택 외의 중개대상물은 국토교통부령으로 전국 일률적으로 정하며, 법정한도를 초과하는 보수 약정은 그 초과 범위에서 무효이고 초과 수령은 금지행위·행정처분·형사처벌의 대상이 된다.",
    intuition:
    ...
    pitfalls:
      "지방자치단체의 조례를 잘못 해석해 법정한도를 초과한 보수를 받았더라도 금지행위가 아니라고 착각하기 쉽지만, 조례 오해는 금지행위 성립을 막는 사유가 아니다.",
    example:
  ...
  },
  {
    ...
    example:
      "주택 면적이 전체의 3분의 1에 불과한 겸용건축물을 중개한 경우, 주택이 아니라 주택 외 중개대상물의 요율표를 적용해 보수를 계산한다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "온라인 커뮤니티를 이용해 특정 가격 이하로 중개를 의뢰하지 않도록 유도하는 행위는 개업공인중개사등뿐 아니라 '누구든지' 해서는 안 되는 금지행위다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "공인중개사 자격취소는 자격증을 교부한 시·도지사가 청문을 거쳐 행하며, 부정한 방법으로 자격을 취득한 경우, 자격증을 대여한 경우, 자격정지기간 중 중개업무를 하거나 다른 개업공인중개사의 소속공인중개사·법인의 임원이 된 경우, 이 법을 위반해 징역형(집행유예 포함)을 선고받은 경우 등에 해당하면 취소해야 한다.",
    intuition:
    ...
    example:
      "공인중개사가 자격정지기간 중에 다른 개업공인중개사의 소속공인중개사가 된 경우, 이는 자격취소사유에 해당한다.",
  },
  {
  ...
  },
  {
    ...
    category: "지도감독·행정처분",
    subcategory: "등록취소",
    titleKo: "중개사무소 개설등록의 필수적 취소사유",
    titleEn: "Mandatory Grounds for Registration Cancellation",
    definition:
      "등록관청은 거짓이나 부정한 방법으로 개설등록을 한 경우, 이중으로 중개사무소의 개설등록을 한 경우, 개업공인중개사인 법인이 해산한 경우, 최근 1년 이내에 2회 업무정지처분을 받고 다시 업무정지처분에 해당하는 행위를 한 경우 등에는 재량 없이 반드시 개설등록을 취소해야 한다.",
    intuition:
    ...
    keyPoints: [
      ...
      "최근 1년 이내에 2회 업무정지처분을 받고 다시 업무정지처분에 해당하는 행위를 한 경우 등록을 취소해야 하며, 업무정지처분을 1회만 받은 경우는 이 요건을 충족하지 못해 해당하지 않는다.",
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "하나의 사건에 대해 2건 이상의 신고가 접수된 경우, 공동신고가 아니면 균등 배분하지 않고 각각 지급한다.",
    ],
    pitfalls:
      "기소유예 결정을 받은 경우에는 포상금을 지급하지 않는다고 착각하기 쉽지만, 기소유예도 공소제기와 함께 지급 요건에 포함된다.",
    example:
      "부정한 방법으로 개설등록한 사실을 신고해 검사가 기소유예 결정을 내린 경우에도, 신고인은 포상금을 받을 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "분사무소설치신고필증의 재교부를 신청하는 자는 조례가 정하는 수수료를 납부해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "부동산 매매계약의 거래당사자가 실제 거래가격을 거짓으로 신고한 사실을 신고하면, 신고포상금 지급대상이 될 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "거래정보사업자가 개인인데 사망한 경우, 국토교통부장관은 그 지정을 취소할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "과태료는 위반 유형에 따라 국토교통부장관·시·도지사·등록관청 중 서로 다른 기관이 부과하며, 등록증 미게시·이전신고 위반·확인설명 불성실 등 행정절차 위반은 과태료 대상이지만 무등록중개업·자격증 대여·거짓 언행에 의한 금지행위처럼 실체적 위반은 과태료가 아니라 형사처벌(징역·벌금) 대상이다.",
    intuition:
    ...
    pitfalls:
      "연수교육 미이수나 자격증 미반납의 부과권자를 등록관청으로 착각하기 쉽지만, 이 두 가지는 시·도지사가 부과한다(자격 관련 사항은 시·도지사 소관).",
    example:
      "무등록으로 중개업을 한 자는 과태료가 아니라 3년 이하의 징역 또는 3천만원 이하의 벌금에 처해진다.",
  },
  {
  ...
  // ───────── 부동산거래신고법 ─────────
  {
    ...
    definition:
      "거래계약서를 작성·교부한 개업공인중개사는 부동산 거래신고 의무를 부담하며, 거래당사자 일방이 신고를 거부하면 다른 당사자가 단독으로 신고할 수 있고, 신고 내용의 오류·계약 변경은 정정신청·변경신고로, 사실관계 확인은 신고관청의 검증·조사로 처리된다.",
    intuition:
  ...
  },
  {
    ...
    example:
      "도시 및 주거환경정비법상 관리처분계획 인가로 취득한 입주자로 선정된 지위(입주권)를 매매하는 계약은 부동산 거래신고 대상이다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "아파트(집합건축물) 매매계약을 신고할 때는 전용면적을 적고, 단독주택(그 밖의 건축물)을 신고할 때는 연면적을 적는다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "자금조달·입주계획서를 매도인·매수인이 공동으로 서명·날인해 제출한다고 착각하기 쉽지만, 실제로는 매수인이 단독으로 작성·제출한다.",
    example:
      "투기과열지구에 소재한 3억원짜리 주택을 자연인이 매수하는 경우, 거래가격이 낮더라도 자금조달·입주계획서를 제출해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "허가신청서 처리기한을 30일로 착각하기 쉽지만, 실제로는 15일 이내에 허가 또는 불허가 처분을 해야 한다.",
    example:
      "생태·경관보전지역과 토지거래허가구역에 동시에 속한 토지를 외국인이 취득하려는 경우, 토지거래계약허가만 받으면 별도의 토지취득허가는 받지 않아도 된다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "방치를 이유로 이행명령을 받고도 시정하지 않으면 취득가액의 10%, 임대를 이유로 이행명령을 받고도 시정하지 않으면 취득가액의 7%가 이행강제금으로 부과된다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "제2종 근린생활시설을 취득해 실제로 영업에 이용하는 자가 그 건물의 일부를 임대하는 것은 이용의무 위반이 아니다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "주거지역에 있는 50㎡의 토지를 거래하는 경우, 면적 기준 이하이므로 토지거래허가를 받을 필요가 없다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "개업공인중개사가 계약금등을 자기 명의로 금융기관에 예치하는 경우, 그 예치금은 자기 소유 재산과 분리해 관리해야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "수탁자가 부동산을 제3자에게 임의로 처분해도 신탁자에 대한 관계에서 횡령죄는 성립하지 않으며, 매도인이나 신탁자는 수탁자를 상대로 매매대금 상당의 부당이득반환청구권을 행사할 수 없다.",
      "명의신탁 사실을 모르는 제3자(예: 수탁자로부터 부동산을 임차한 임차인)는 유효하게 임차권을 취득해 신탁자·매도인 누구에게든 대항할 수 있다.",
    ],
    pitfalls:
      "3자간 등기명의신탁에서 매매계약 자체가 무효라고 착각하기 쉽지만, 무효인 것은 명의신탁약정과 그에 따른 등기일 뿐 신탁자·매도인 간 매매계약은 유효하다.",
    example:
      "甲이 乙 소유 토지를 매수하며 등기만 친구 丙 앞으로 이전한 경우, 甲은 매매계약을 근거로 乙에게 소유권이전등기를 청구할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "매도인이 명의신탁 사실을 몰랐다면 수탁자 명의의 등기는 유효해 수탁자가 소유권을 취득하지만, 신탁자는 수탁자에게 매수자금 상당의 부당이득반환만 청구할 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "명의신탁 관련 과징금·이행강제금의 부과대상을 명의수탁자로 착각하기 쉽지만, 실제 부과대상은 명의신탁자다.",
    example:
      "배우자 명의로 부동산을 등기했더라도 조세포탈 등의 목적이 없었다면 그 등기는 유효하다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "임차인이 계약갱신요구권을 1회 행사해 갱신된 이후에도, 임차인은 언제든지 계약해지를 통지할 수 있고 통지 후 3개월이 지나면 해지 효력이 발생한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "주택임대차보호법은 주거용 건물(일부가 주거 외 목적으로 쓰여도 포함)의 임대차와 미등기 전세계약에 준용되며, 2년 미만으로 정한 기간은 임차인만 그 유효함을 주장하지 않을 수 있고, 묵시적 갱신 시 존속기간은 2년으로 본다.",
    intuition:
    ...
    keyPoints: [
      ...
      "임대차기간을 2년 미만으로 정한 경우 그 기간은 임차인만 유효함을 주장하지 않을 수 있다(임대인은 주장할 수 없다).",
    ...
    example:
      "임대차기간을 1년으로 정한 경우, 임차인은 2년의 기간이 유효함을 주장할 수도 있고 약정한 1년의 기간을 주장할 수도 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "상가임차인의 계약갱신요구권은 최초의 임대차기간을 포함한 전체 임대차기간이 10년을 초과하지 않는 범위에서 행사할 수 있고, 임차인이 3기분의 차임을 연체하거나 임대인의 동의 없이 전대한 경우 등에는 임대인이 갱신을 거절할 수 있다.",
    intuition:
    ...
    pitfalls:
      "계약갱신요구권의 행사 가능 기간을 5년으로 잘못 암기하기 쉽지만, 2018년 법 개정으로 10년까지 확대되었다.",
    example:
      "임차인이 전체 임대차기간 8년째에 갱신을 요구하면, 10년을 넘지 않으므로 임대인은 정당한 사유 없이 거절할 수 없다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "환산보증금(보증금 + 월차임×100)이 지역별 기준을 초과하면 기간의제(제9조)·우선변제권(제5조) 등 일부 규정은 적용되지 않지만, 대항력(제3조)과 3기 차임연체 시 해지, 계약갱신요구권 등 핵심 조항은 환산보증금과 무관하게 적용된다.",
    intuition:
      "환산보증금 기준은 상가임대차법의 어느 조항까지 받을 수 있는가를 가르는 문턱이므로, 초과해도 살아남는 조항(대항력·갱신요구권·연체해지)과 배제되는 조항(기간의제·우선변제권)을 구분해 암기해야 한다.",
    keyPoints: [
      "환산보증금이 지역별 기준을 초과하면, 기간을 정하지 않은 경우 1년으로 의제하는 규정과 확정일자에 의한 우선변제권 규정은 적용되지 않지만, 대항력을 갖춘 임차인의 지위는 건물 양수인에게 승계되고 3기 차임연체 시 해지할 수 있다는 규정은 환산보증금과 무관하게 적용된다.",
    ...
    pitfalls:
      "묵시적 갱신을 계약이 해지된 것으로 착각하기 쉽지만, 실제로는 전 임대차와 동일한 조건으로 갱신된 것으로 본다.",
    example:
      "환산보증금이 지역기준을 초과하는 상가라도, 임차인이 건물을 인도받고 사업자등록을 마쳤다면 대항력은 그대로 인정된다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "최저매각가격 2억원, 최고가매수신고액이 2억 5천만원인 경매에서 차순위매수신고를 하려면 그 신고액이 2억 3천만원(=2억5천만-2천만 보증액)을 넘어야 한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "매각부동산 위의 저당권은 순위와 무관하게 매각으로 모두 소멸하고 최선순위 전세권도 배당요구를 하면 소멸하지만, 최선순위 지상권과 경매개시결정 기입등기 전에 성립한 유치권은 매수인이 인수하며, 대항력 없는 임차권은 매각으로 소멸한다.",
    intuition:
    ...
    example:
      "선순위 저당권이 설정된 부동산이 후순위 저당권자의 신청으로 경매되어도, 선순위 저당권은 매각으로 소멸한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "매수신청대리인이 되려면 공인중개사인 개업공인중개사 또는 법인인 개업공인중개사가 주된 사무소 소재지를 관할하는 지방법원장에게 등록해야 하며(소속공인중개사는 등록 불가), 공인중개사 자격이 취소되면 지방법원장은 그 등록을 취소해야 하지만 폐업신고로 인한 등록취소는 3년 재등록 제한과 무관하다.",
    intuition:
    ...
    example:
      "국세징수법에 따른 공매대상 부동산의 입찰을 대리하려는 개업공인중개사는 법원에 별도로 등록할 필요가 없다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "위임인의 입찰이 최고가매수신고인이나 차순위매수신고인이 되지 못한 경우, 매수신청대리인은 위임인을 대신해 매수신청보증의 반환을 신청할 수 있다.",
    questionRefs: [
