...
const concepts: Concept[] = [
  ...
  },
  {
    ...
    example:
      "농지지역이 택지지역으로 전환되고 있는 토지는 후보지이지만, 주거지역 안에서 상업지역으로 전환되고 있는 토지는 이행지다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "한국표준산업분류상 부동산업은 부동산 임대 및 공급업과 부동산 관련 서비스업(부동산 관리업, 부동산 중개·자문 및 감정평가업)으로 분류되며, 부동산 관리업은 다시 주거용·비주거용 부동산 관리업으로 나뉜다.",
    intuition:
      "부동산업 분류는 '내가 부동산을 직접 임대·공급하는가(임대 및 공급업)'와 '남의 부동산을 관리·중개·평가해주는가(관련 서비스업)'로 먼저 나눈 뒤, 후자를 다시 세분한다고 이해하면 된다.",
    keyPoints: [
    ...
    pitfalls:
      "부동산 개발 및 공급업을 부동산 '관련 서비스업'으로 착각하기 쉽지만, 이는 부동산 임대 및 공급업 계열에 속해 서비스업 분류에는 포함되지 않는다.",
    example:
      "아파트 관리업무를 수행하는 회사는 한국표준산업분류상 부동산 관리업(부동산 관련 서비스업)으로 분류된다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "영속성 덕분에 부동산은 감가상각을 하지 않으므로, 수익환원법(직접환원법)처럼 미래수익을 가정한 평가방법을 적용할 수 있다.",
    questionRefs: [
  ...
  // ───────── 부동산학 각론 ─────────
  {
    ...
    definition:
      "수요량·공급량은 일정 가격에서 수요자·공급자가 사고자·팔고자 하는 최대수량을 뜻하며, 가격 변화에 의한 변화는 곡선상의 이동(변화량)으로 나타나고, 시장수요곡선은 개별수요곡선을 수평으로 합해 도출하며, 수요가 증가할 때 공급이 비탄력적일수록 균형가격은 더 크게 상승한다.",
    intuition:
    ...
    pitfalls:
      "시장수요곡선을 개별수요곡선의 수직 합으로 착각하기 쉽지만, 실제로는 수평으로 합하여 도출한다.",
    example:
      "공급이 완전비탄력적인 토지 시장에서 수요가 증가하면, 공급량 변화 없이 가격만 크게 오른다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "주택거래량을 저량으로 착각하기 쉽지만, 일정 기간(예: 1년) 동안 거래된 양이므로 유량이다.",
    example:
      "특정 시점의 주택재고량은 저량이지만, 그 해에 새로 공급된 신규주택 공급량은 유량이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "가격 자체가 아닌 소득·선호도·대체재가격·금리·정책 등의 변화는 수요곡선이나 공급곡선 자체를 이동시키는 '변화요인'이며, 이는 동일한 곡선상에서 움직이는 가격에 의한 변화량과 구분된다.",
    intuition:
      "무엇이 바뀌었는가를 먼저 확인해 그것이 가격인지 가격 외 요인인지를 가리면, 곡선상의 이동(변화량)인지 곡선 자체의 이동(변화)인지가 자동으로 정해진다.",
    keyPoints: [
    ...
    pitfalls:
      "건축비 하락이나 원가절감기술개발을 공급 감소 요인으로 착각하기 쉽지만, 이는 생산비용을 낮춰 공급을 증가시키는 요인이다.",
    example:
      "가구의 실질소득이 증가하고 아파트 선호도가 감소하는 경우, 두 요인이 수요에 미치는 영향이 상반되므로 균형가격의 최종 변화는 그 상대적 크기에 따라 결정된다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "개별수요함수를 수평합할 때 가격(P) 기준으로 그대로 더하는 실수를 하기 쉽지만, 반드시 수량(Q)에 대해 정리한 뒤 더해야 한다.",
    example:
      "수요함수가 Qd=600-1.5P인 경우, 분양수입극대화 가격은 한계수입이 0이 되는 P=200(만원/㎡)에서 결정된다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "수요와 공급이 동시에 변화할 때 균형가격과 균형거래량의 변화 방향은 각 곡선의 증가·감소 여부와 그 변화폭의 상대적 크기에 따라 결정되며, 같은 방향으로 변화하면 거래량은 그 방향대로 확정되고 가격은 변화폭이 큰 쪽이 우세하고, 반대 방향으로 변화하면 가격은 그 방향대로 확정되고 거래량은 변화폭이 큰 쪽이 우세하다.",
    intuition:
      "숫자 없이 방향만 묻는 문제는 결국 '같은 방향이면 거래량이, 반대 방향이면 가격이 자동으로 정해지고, 나머지 하나는 변화폭 대결로 정해진다'는 규칙 하나만 정확히 적용하면 풀린다.",
    keyPoints: [
    ...
    pitfalls:
      "변화폭의 크고 작음을 따지지 않고 방향만으로 가격·거래량을 단정하기 쉽지만, 같은 방향으로 변화할 때는 가격이, 반대 방향으로 변화할 때는 거래량이 두 변화폭의 상대적 크기에 따라 달라진다.",
    example:
      "수요는 감소하고 공급은 증가하는데 수요의 감소폭이 공급의 증가폭보다 작다면, 균형가격은 하락하고 균형거래량은 증가한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "허프모형은 소비자가 특정 매장을 방문할 확률이 매장의 크기(매력도)에 비례하고 소비자와 매장 사이 거리의 공간(거리)마찰계수 거듭제곱에 반비례한다고 보아, 각 매장의 이용확률과 예상 매출액을 추정하는 확률모형이다.",
    intuition:
      "허프모형은 레일리의 도시 단위 인력모형을 개별 소비자·개별 매장 단위로 쪼갠 것이므로, '매장 크기는 끌어당기는 힘, 거리는 밀어내는 힘'이라는 구조를 그대로 가져와 이해하면 된다.",
    keyPoints: [
    ...
    example:
      "교통조건이 나빠지면 소비자들이 먼 매장 방문을 꺼리게 되어 공간마찰계수가 커진다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "입지계수(LQ)는 '해당 지역의 특정 산업 고용비중 ÷ 전체 지역의 그 산업 고용비중'으로 계산하며, LQ가 1보다 크면 그 산업은 해당 지역에서 특화된 기반산업(수출산업)으로 판별한다.",
    intuition:
      "LQ는 결국 '그 지역이 전국 평균보다 이 산업에 얼마나 더 치우쳐 있는가'를 나타내는 비율이므로, 1을 기준으로 그보다 크면 특화, 작으면 비특화라고 이해하면 된다.",
    keyPoints: [
    ...
    pitfalls:
      "LQ 계산 시 분모·분자를 뒤바꾸는 실수가 잦다 — 지역 내 비중을 전국 비중으로 나누는 순서를 정확히 지켜야 한다.",
    example:
      "A지역에서 X산업의 LQ가 1.2로 계산되면, X산업은 A지역의 기반산업으로 분류된다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "베버는 최소운송비 지점·최소노동비 지점·집적이익을 종합적으로 고려해 비용이 최소화되는 지점을 공장의 최적입지로 보았으며, 원료지수(국지원료 중량÷제품 중량)가 1보다 크면 원료지향적, 제품 중량이 원료 중량보다 크면 시장지향적 입지를 선호한다고 설명했다.",
    intuition:
      "베버의 이론은 '어디에 공장을 지어야 운송비·노동비 합이 가장 작은가'라는 질문에 답하는 이론이므로, 수익이 아니라 비용을 최소화하는 관점이라는 것이 핵심이다.",
    keyPoints: [
    ...
    pitfalls:
      "베버의 이론을 '최대수익이 최적입지 기준'이라고 착각하기 쉽지만, 베버는 비용(운송비·노동비) 최소화 관점에서 최적입지를 설명한다.",
    example:
      "국지원료의 중량이 제품 중량보다 훨씬 무거운 산업(예: 시멘트 산업)은 원료지수가 1보다 커서 원료산지 인근에 입지하려는 경향을 보인다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "인구가 적은 소도시에서는 종합병원처럼 최소요구치가 큰 고차 중심기능이 유지되기 어렵다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "리카도의 차액지대설은 토지의 비옥도 차이와 수확체감현상에 따라 우등지·열등지 간 생산비 차이로 지대가 발생한다고 보아 최열등지(한계지)에는 지대가 없다고 설명하고, 마르크스의 절대지대설은 토지의 생산성과 무관하게 토지의 사적 소유(독점) 자체에서 지대가 발생해 최열등지에도 지대가 있다고 보며, 튀넨의 위치지대설은 중심지와의 거리(수송비) 차이에 따라 지대가 달라진다고 설명하고, 마샬의 준지대는 단기적으로 공급이 고정된 자본재에 귀속되는 일시적 잉여를 말한다.",
    intuition:
      "네 이론은 '지대가 왜 생기는가'에 대한 서로 다른 답이므로, 원인(비옥도 차이·소유의 독점·위치·일시적 공급고정)만 짝지으면 학자별 이론이 자연스럽게 구분된다.",
    keyPoints: [
    ...
    example:
      "도시 중심지와 가까운 농지일수록 수송비가 적게 들어 지대가 높게 형성된다는 설명은 튀넨의 위치지대설에 해당한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "버제스의 동심원이론은 튀넨의 농업입지 원리를 도시에 적용해 중심업무지구·점이지대·저소득층주거지대·고소득층주거지대·통근자지대 순으로 동심원 구조가 형성된다고 보고, 호이트의 선형이론은 교통축을 따라 부채꼴(선형)로 도시가 성장한다고 보며, 해리스와 울만의 다핵심이론은 단일 중심이 아니라 여러 개의 분리된 핵이 점진적으로 통합되며 도시구조가 형성된다고 본다.",
    intuition:
    ...
    example:
      "도시가 하나의 중심이 아니라 공업·소매·고급주택 등 여러 개의 분리된 핵을 중심으로 성장한다는 설명은 해리스와 울만의 다핵심이론에 해당한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "요구수익률은 위험을 감안해 투자자가 최소한 요구하는 수익률이고 기대수익률은 투자안에서 실제로 예상되는 수익률이며, 기대수익률이 요구수익률보다 클 때 투자가치가 있다고 판단하고 위험이 클수록 요구수익률도 높아진다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "정보의 현재가치는 개발이 확실하다고 가정했을 때의 현재가치와, 불확실성이 반영된 기댓값의 현재가치의 차액으로 계산하며, 이는 투자자가 그 정보를 미리 알기 위해 최대한 지불할 수 있는 금액이다.",
    intuition:
      "정보의 가치는 '불확실성을 없애주면 얼마나 이득인가'로 측정되므로, 확실한 미래의 현재가치에서 불확실한 상태의 기댓값 현재가치를 빼는 것으로 계산된다고 이해하면 된다.",
    keyPoints: [
    ...
    pitfalls:
      "정보의 현재가치를 단순히 '개발 시 가격의 현재가치'로 착각하기 쉽지만, 실제로는 확실한 경우의 현재가치에서 불확실한 기댓값의 현재가치를 뺀 차액이다.",
    example:
      "2년 후 개발이 확실하다면 A토지 가격의 현재가치가 더 높게 계산되며, 그 값과 불확실성을 반영한 기댓값의 현재가치와의 차이가 정보의 현재가치다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "위험할증률과 예상인플레이션율을 요구수익률 계산에서 빠뜨리기 쉽다 — 요구수익률은 무위험률·위험할증률·예상인플레이션율을 모두 더해 구한다.",
    example:
      "무위험률 3%, 위험할증률 4%, 예상인플레이션율 2%인 경우 요구수익률은 9%이며, 예상순수익이 4,500만원이면 투자가치는 5억원(=4,500만원÷0.09)이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "순현재가치(NPV)는 현금유입의 현재가치에서 현금유출의 현재가치를 뺀 값, 내부수익률(IRR)은 NPV를 정확히 0으로 만드는 할인율, 수익성지수(PI)는 현금유입의 현가를 현금유출의 현가로 나눈 비율이며, 셋 모두 화폐의 시간가치를 반영하는 할인현금흐름법에 속한다.",
    intuition:
    ...
    pitfalls:
      "내부수익률(IRR)을 순현가를 1로 만드는 할인율이라고 착각하기 쉽지만, 정확히는 순현가를 0으로 만드는 할인율이다.",
    example:
  ...
  },
  {
    ...
    definition:
      "매 기간의 순영업소득이나 순현금흐름을 요구수익률(할인율)로 각각 할인해 현재가치를 구하고, 이를 합산해 순현재가치(NPV)나 수익성지수(PI)를 계산한다.",
    intuition:
    ...
    pitfalls:
      "현금흐름을 할인하지 않고 단순 합산해 NPV나 PI를 계산하는 실수를 하기 쉽다 — 반드시 각 기간의 현금흐름을 현재가치로 할인한 뒤 합산해야 한다.",
    example:
      "3년간 순영업소득이 매년 다르게 주어진 경우, 각 연도의 순영업소득을 요구수익률로 할인한 현재가치를 모두 더하면 그 합계가 된다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "부채감당률(DCR)은 순영업소득을 부채서비스액으로 나눈 값, 채무불이행률(손익분기율)은 영업경비와 부채서비스액의 합을 유효총소득으로 나눈 값이며, 대부비율(LTV)·부채비율·총자산회전율 등 비율분석법의 여러 지표는 각기 다른 분자·분모 조합으로 투자안의 안전성과 수익성을 나타낸다.",
    intuition:
  ...
  },
  {
    ...
    definition:
      "순소득승수(총투자액÷순영업소득), 총소득승수(총투자액÷유효총소득), 세전·세후현금흐름승수(지분투자액÷세전·세후현금흐름), 부채감당률(순영업소득÷부채서비스액), 단순회수기간(초기투자액을 매기 현금흐름으로 회수하는 데 걸리는 기간) 등은 모두 운영수지표에서 주어진 항목을 대입해 계산한다.",
    intuition:
      "승수 계열 지표는 결국 '투자액을 어떤 소득으로 나누는가'의 문제이므로, 분자가 총투자액인지 지분투자액인지, 분모가 순영업소득·유효총소득·세전현금흐름·세후현금흐름 중 무엇인지만 정확히 짝지으면 계산 자체는 단순하다.",
    keyPoints: [
    ...
    pitfalls:
      "순소득승수와 총소득승수를 혼동해 분모에 다른 소득 항목을 넣는 실수를 하기 쉽다 — 순소득승수는 순영업소득, 총소득승수는 유효총소득을 분모로 쓴다.",
    example:
      "총투자액이 10,000만원이고 순영업소득이 1,000만원이면 순소득승수는 10이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "원리금균등상환은 매기 원리금 총액이 동일하고 회차가 지날수록 이자상환분이 줄고 원금상환분이 늘어나며, 원금균등상환은 매기 원금상환액이 동일해 원리금과 대출잔액이 점차 감소하고, 체증(점증)식상환은 초기 상환액을 적게 하다가 점차 늘리며, 만기일시상환은 만기까지 이자만 내다가 만기에 원금을 일시상환한다.",
    intuition:
      "매기 갚는 '총액'을 고정시켰는지(원리금균등), '원금'을 고정시켰는지(원금균등), 아예 뒤로 미뤘는지(체증식·만기일시)에 따라 이자총액과 duration이 달라진다고 이해하면 비교 문제를 풀기 쉽다.",
    keyPoints: [
    ...
    example:
      "동일한 대출조건이라면 대출채권의 가중평균상환기간(duration)은 원금균등상환방식이 원리금균등상환방식보다 짧다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "회차별 이자를 최초 대출원금 기준으로 계속 계산하는 실수를 하기 쉽다 — 이자는 매 회차 남아있는 대출잔액을 기준으로 다시 계산해야 한다.",
    example:
      "원리금균등상환 대출에서 9회차 원리금상환액이 일정하게 주어졌다면, 그 회차의 이자납부액은 8회차까지 상환된 원금을 차감한 대출잔액에 이자율을 곱해 구한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "MPTS는 지분형 증권으로 조기상환위험·채무불이행위험 모두 투자자가 부담하고, MBB는 채권형 증권으로 발행자가 초과담보를 제공하며 그 위험을 모두 발행자가 부담하고(투자자는 위험을 부담하지 않음), MPTB는 조기상환위험은 투자자가·채무불이행위험은 발행자가 부담하며, CMO는 상환우선순위와 만기가 다른 여러 트랜치로 구성된다.",
    intuition:
      "MBS 상품군은 '위험을 발행자가 안느냐, 투자자가 안느냐'라는 한 가지 축으로 정리하면 된다 — MPTS는 투자자가 다 안고, MBB는 발행자가 다 안으며, MPTB는 그 중간이다.",
    keyPoints: [
      "MPTS(지분형)는 조기상환위험·채무불이행위험을 모두 투자자가 부담하며, MBB(채권형)는 발행자가 초과담보를 제공하고 그 위험을 모두 발행자가 부담해 MBB 투자자는 조기상환위험·채무불이행위험을 부담하지 않는다(초과담보를 제공하지 않는다는 서술은 틀렸다).",
    ...
    pitfalls:
      "MBB 투자자가 조기상환위험을 부담한다고 착각하기 쉽지만, MBB는 발행자가 초과담보로 그 위험을 전부 흡수하므로 투자자는 위험을 부담하지 않는다.",
    example:
      "MBB는 채권형 증권으로 발행자가 초과담보를 제공하므로, 기초 대출의 채무불이행이 발생해도 MBB 투자자에게는 원리금이 그대로 지급된다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "ABCP의 반복적 유동화 등록기관을 금융감독원으로 착각하기 쉽지만, 실제 등록기관은 금융위원회다.",
    example:
      "프로젝트 파이낸싱 대출채권은 자산유동화법에 따른 ABS뿐 아니라 상법상 방법에 따른 ABCP로도 유동화될 수 있다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "가중평균상환기간(duration)이 긴 채권일수록 가격변동폭이 작다고 착각하기 쉽지만, 실제로는 duration이 길수록 금리변동에 더 민감해 가격변동폭이 크다.",
    example:
      "채권시장 수익률이 상승하면, 고정이자를 지급하는 저당담보부증권의 가격은 하락한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "주거환경개선사업은 정비기반시설이 극히 열악하고 저소득 주민이 밀집한 지역(또는 단독·다세대주택 밀집지역)의 주거환경을 보전·정비·개량하는 사업이고, 재개발사업은 정비기반시설이 열악하고 노후·불량건축물이 밀집한 지역이나 상업·공업지역의 도시기능 회복·상권활성화를 위한 사업이며, 재건축사업은 정비기반시설은 양호하지만 노후·불량건축물인 공동주택이 밀집한 지역의 주거환경을 개선하는 사업이다.",
    intuition:
    ...
    example:
      "노후·불량건축물이 밀집한 상업지역의 상권을 활성화하기 위한 정비사업은 재개발사업에 해당한다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "BTO는 준공과 동시에 소유권이 국가에 귀속되고 민간사업자가 시설을 직접 운영해 사용료를 징수하는 방식, BTL은 준공과 동시에 소유권이 국가에 귀속되고 국가·지방자치단체가 그 시설을 임차해 사용·수익하는 방식(민간은 임대료를 받음), BOT는 준공 후 일정기간 민간사업자가 소유·운영하다가 기간 만료 시 국가에 소유권을 이전하는 방식, BOO는 민간사업자가 소유권을 계속 보유하며 운영하는 방식이다.",
    intuition:
    ...
    example:
      "학교시설처럼 이용자에게 사용료를 징수하기 어려운 시설은 BTL 방식으로, 유료도로처럼 사용료 징수가 가능한 시설은 BTO 방식으로 추진되는 경우가 많다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "도시개발사업의 토지취득방식은 개발토지 전체를 원소유자에게 재배분하는 환지방식과 사업시행자가 토지를 매수·수용하는 수용방식으로 나뉘며, 지주공동사업 방식은 토지소유자가 소유권을 유지한 채 개발업자에게 수수료를 주고 사업을 맡기는 사업위탁(수탁)방식, 신탁회사가 소유권을 이전받아 사업주체가 되는 신탁개발방식 등으로 구분된다.",
    intuition:
    ...
    pitfalls:
      "환지방식이 수용방식보다 절차가 더 간단하다고 착각하기 쉽지만, 실제로는 토지소유자 동의 절차가 더 많아 절차가 더 복잡하다.",
    example:
      "농지를 택지로 개발한 후 보류지를 제외한 개발토지 전체를 종전 토지소유자에게 배분하는 방식은 환지방식이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "STP전략은 시장세분화(Segmentation)·표적시장 선정(Targeting)·포지셔닝(Positioning)으로 구성되고, 시장점유 마케팅전략은 4P Mix·STP전략을 통해 시장을 점유하려는 공급자 측면 접근이며, 고객점유 마케팅전략은 AIDA(주의-관심-욕구-행동) 원리에 따라 고객의 의사결정 과정에 개입하는 전략이고, 관계마케팅전략은 고객과의 지속적 관계 유지를 통해 마케팅효과를 도모하는 전략이다.",
    intuition:
      "부동산마케팅 전략은 '시장을 어떻게 나누고 겨냥할 것인가(STP)', '시장 전체를 어떻게 차지할 것인가(시장점유)', '고객 한 명 한 명의 마음을 어떻게 움직일 것인가(고객점유·관계마케팅)'라는 세 층위로 나눠 이해하면 정리된다.",
    keyPoints: [
    ...
    pitfalls:
      "AIDA 원리의 세 번째 단계를 '결정(Decision)'으로 착각하기 쉽지만, 정확히는 '욕구(Desire)'다.",
    example:
      "빠른 자금회수가 필요하고 지역 구매자의 구매력이 낮은 경우에는 저가전략을 사용하는 것이 합리적이다.",
    questionRefs: [
  ...
  },
  {
    ...
    definition:
      "부동산마케팅의 4P는 제품(Product)·가격(Price)·유통경로(Place)·판매촉진(Promotion)이며, 긍지(Pride)·홍보(PR)·포지셔닝(Positioning)·동반자관계(Partnership) 등은 4P에 해당하지 않는다.",
    intuition:
      "4P는 '무엇을 팔지(제품)·얼마에 팔지(가격)·어디서 팔지(유통경로)·어떻게 알릴지(판매촉진)'라는 네 질문에 대응하므로, 그 밖의 P로 시작하는 용어(포지셔닝·긍지·홍보 등)는 다른 전략(STP 등)에 속한다고 구분하면 된다.",
    keyPoints: [
    ...
    pitfalls:
      "포지셔닝을 4P의 구성요소로 착각하기 쉽지만, 포지셔닝은 STP전략의 한 단계이지 4P Mix의 구성요소가 아니다.",
    example:
      "아파트 분양 모델하우스 방문객에게 경품을 추첨으로 제공하는 것은 4P 중 판매촉진(Promotion) 전략에 해당한다.",
    questionRefs: [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "개별주택가격·공동주택가격에 이의가 있는 자는 결정·공시일부터 30일 이내에 서면(전자문서 포함)으로 시장·군수·구청장에게 이의를 신청할 수 있으며, 분할·합병 등이 발생한 경우 그 기준일은 7월 1일이 아니라 대통령령으로 정하는 날이다.",
    ],
    pitfalls:
      "표준주택가격의 조사·산정을 감정평가법인등에게 의뢰한다고 착각하기 쉽지만, 표준주택가격은 한국부동산원에 의뢰해 조사·산정한다(표준지공시지가는 감정평가법인등에게 의뢰).",
    example:
      "표준주택으로 선정된 단독주택은 그 주택의 표준주택가격이 있으므로, 시장·군수·구청장은 별도로 개별주택가격을 결정·공시하지 않을 수 있다.",
    questionRefs: [
