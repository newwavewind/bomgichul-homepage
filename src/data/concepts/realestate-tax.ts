...
const concepts: Concept[] = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "1구의 건물이 주거와 주거 외 용도로 함께 쓰이는 경우 주거용 면적이 전체의 100분의 60 이상이면 전체를 주택으로 본다.",
    ...
    example:
      "1층은 상가, 2층은 주거용으로 쓰이는 건물에서 주거용 면적이 전체의 60% 이상이라면, 그 건물 전체를 주택으로 본다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "상속이 개시되었으나 상속등기를 하지 않고 사실상 소유자 신고도 하지 않았다면, 행정안전부령으로 정하는 주된 상속자가 재산세 납세의무자가 된다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "건축허가 없이 스스로 건설한 건축물을 사실상 2020년부터 사용해왔다면, 사용승인을 그 이후에 받았더라도 취득시기는 사실상 사용을 시작한 시점이다.",
    questionRefs: [
  ...
  },
  {
    ...
    example:
      "양도가액이 25억원인 고가주택을 양도해 전체 양도차익이 5억원이라면, 과세대상 양도차익은 5억원 × (25억원－12억원)/25억원으로 안분 계산한다.",
    questionRefs: [
  ...
  },
  {
    ...
    pitfalls:
      "배우자 간 부담부증여는 채무인수가 항상 인정된다고 착각하기 쉽다 — 수증자에게 인수되지 않은 것으로 추정되는 채무액은 제외된다.",
    example:
      "지가 급등 우려로 국세청장이 지정한 지역의 토지는 기준시가를 배율방법으로 평가해 양도차익 계산에 활용한다.",
    questionRefs: [
  ...
  },
  {
    ...
    keyPoints: [
      "등기된 상업용 건물을 보유기간 1년 이상 2년 미만 보유 후 양도하면 100분의 50의 세율이 적용된다(100분의 40이 아님).",
      "분양권은 주택 수와 관계없이 보유기간 1년 미만이면 100분의 70, 1년 이상이면 100분의 60의 세율이 적용된다.",
      "분양권의 세율은 다른 부동산과 달리 보유기간 구간이 단순화되어 있다는 점이 특징이다.",
    ],
    pitfalls:
      "상업용 건물의 단기양도세율을 주택과 동일하게 적용한다고 착각하기 쉽다 — 자산 종류별로 세율표가 다르다.",
    example:
      "보유기간 10개월인 분양권을 양도하면 1년 미만 기준에 해당해 100분의 70의 세율이 적용된다.",
    questionRefs: [
  ...
  },
  {
    ...
    keyPoints: [
      "혼인특례는 혼인한 날부터 5년, 동거봉양 특례는 합가일로부터 10년 이내 먼저 양도하는 주택에 적용되며, 두 특례 모두 직계존속(배우자의 직계존속 포함) 연령기준은 60세다.",
    ...
    pitfalls:
      "동거봉양 특례의 양도기한을 혼인특례와 같은 5년으로 착각하기 쉽다 — 동거봉양 특례는 10년이다.",
    example:
      "혼인으로 일시적 2주택이 된 경우, 혼인한 날부터 5년 이내에 먼저 양도하는 주택은 1세대 1주택으로 보아 비과세 특례를 적용받을 수 있다.",
    questionRefs: [
