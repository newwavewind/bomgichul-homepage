...
export const gugeoIntro: ExamIntro = {
  id: "gugeo",
  eyebrow: "9급 공무원 국어",
  title: "공무원 국어 시험 안내",
  summary:
    "공무원 국어는 독립 자격이 아니라 9급 공개경쟁채용 필기의 한 과목입니다. 일정·접수는 국가직·지방직 공무원 공고를 따릅니다.",
  hubHref: "/gugeo",
  hubCta: "공무원 국어 학습 시작",
  ...
  administrator: {
    ...
    description:
      "국어 과목의 시행·접수는 9급 공무원 채용 공고에 포함됩니다. 별도 ‘국어 시험’ 원서는 없습니다.",
  },
  tracks: {
    title: "응시 맥락",
    groups: [
  ...
  subjects: {
    ...
    groups: [
      {
        name: "필기 과목 중",
        items: [{ name: "국어", round: "필수", note: "9급 공채 필기" }],
      },
    ],
  },
  format: {
    title: "시험 형식",
    paragraphs: [
      "국어는 9급 필기 필수과목 중 하나로 객관식입니다. 문항 수·배점은 해당 채용 공고의 과목표를 확인하세요.",
    ],
    bullets: [
      "원서·일정은 공무원 채용 공고를 따릅니다.",
      "국어만 따로 접수하는 시험은 없습니다.",
    ],
  },
  timetable: {
    title: "2026년 국가직 9급 필기 (국어 포함)",
    rows: [
  ...
  schedule: {
    ...
    items: [
      {
        ...
        date: "2026-04-04",
        detail: "원서 2026년 2월 2일～6일 · 국어만 따로 접수하지 않음 (시행 완료)",
      },
      {
        label: "지방직·다음 연도",
    ...
    note: "국어 단독 시험일이 없습니다. 공무원 필기일을 기준으로 하세요.",
  },
  application: {
    title: "원서 접수",
    ...
    how: [
      ...
      "국어는 필기 과목이므로 별도 국어 시험 원서는 없습니다.",
    ],
    links: [
      {
        label: "국가공무원채용시스템",
        href: "https://www.gongmuwon.gosi.kr/",
        external: true,
      },
  ...
  relatedLinks: [
    { label: "FAQ", href: "/gugeo/faq" },
    { label: "커뮤니티", href: "/gugeo/community" },
    { label: "공무원 시험 안내", href: "/public-service/intro" },
    { label: "공무원 영어", href: "/english" },
  ],
  sources: [
    {
      label: "공무원(국가직 9급) 시험 안내와 동일 출처",
      href: "/public-service/intro",
      note: "국어는 9급 필기 과목이므로 공고·일정은 공무원 소개 페이지의 근거를 따릅니다.",
    },
  ],
  seoDescription:
    "9급 공무원 국어 시험 안내. 국가직·지방직 필기 과목으로서의 일정·접수와 봄기출 국어 기출 학습.",
};
